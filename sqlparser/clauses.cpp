...
bool SqlParser::AlterColumnClause(Token *table, Token *table_name,
                                  Token *alter) {
  if (alter == NULL)
    return false;
...
bool SqlParser::ParseSequenceOptions(Token **start_with_out,
                                     Token **increment_by_out,
                                     StatsSummaryItem &ssi) {
  bool exists = false;
                ...
                if (TOKEN_CMP(option, "CACHE")) {
                  ...
                  if (TOKEN_CMP(option, "NOCACHE")) {
                    ...
                    if (TOKEN_CMP(option, "NOCYCLE")) {
                      ...
                      STATS_DTL_CONV_NO_NEED(
                          Target(SQL_ORACLE, SQL_MARIADB_ORA))
                      ...
                      if (TOKEN_CMP(option, "CYCLE")) {
                        ...
                        if (TOKEN_CMP(option, "NOORDER")) {
                          ...
                          STATS_DTL_CONV_OK(Target(SQL_ORACLE, SQL_MARIADB_ORA),
                                            STATS_CONV_VERY_LOW,
                                            SEQUENCE_NOORDER_CONV, "")
                          ...
                          if (TOKEN_CMP(option, "ORDER")) {
                            if (Target(SQL_MYSQL))
                              Token::Remove(option);
                            else if (Target(SQL_MARIADB))
                              COMMENT_WARN(option, NULL);

                            STATS_DTL_DESC(SEQUENCE_ORDER_DESC)
                            STATS_DTL_CONV_ERROR(
                                Target(SQL_MARIADB_ORA), STATS_CONV_HIGH,
                                SEQUENCE_ORDER_CONV, SEQUENCE_ORDER_URL)
                            ...
                            if (TOKEN_CMP(option, "NOKEEP")) {
                              ...
                              STATS_DTL_CONV_OK(
                                  Target(SQL_ORACLE, SQL_MARIADB_ORA),
                                  STATS_CONV_VERY_LOW, SEQUENCE_NOKEEP_CONV, "")
                              ...
                              if (TOKEN_CMP(option, "KEEP")) {
                                ...
                                STATS_DTL_CONV_ERROR(Target(SQL_MARIADB_ORA),
                                                     STATS_CONV_HIGH,
                                                     SEQUENCE_KEEP_CONV, "")
                                ...
                                if (TOKEN_CMP(option, "GLOBAL")) {
                                  ...
                                  STATS_DTL_CONV_OK(
                                      Target(SQL_ORACLE, SQL_MARIADB_ORA),
                                      STATS_CONV_VERY_LOW, SEQUENCE_GLOBAL_CONV,
                                      "")
