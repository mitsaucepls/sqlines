...
bool SqlParser::ParseFunction(Token *name) {
  ...
  else if (name->Compare("ABSVAL", L"ABSVAL", 6) == true)
    exists = ParseFunctionAbsval(name, open);
  else if (name->Compare("ACOS", L"ACOS", 4) == true)
    exists = ParseFunctionAcos(name, open);
  else if (name->Compare("ADDDATE", L"ADDDATE", 7) == true)
    exists = ParseFunctionAddDate(name, open);
  else if (name->Compare("ADD_MONTHS", L"ADD_MONTHS", 10) == true)
    exists = ParseFunctionAddMonths(name, open);
  else if (name->Compare("ARGN", L"ARGN", 4) == true)
    exists = ParseFunctionArgn(name, open);
  else if (name->Compare("ASCII", L"ASCII", 5) == true)
    exists = ParseFunctionAscii(name, open);
  else if (name->Compare("ASCIISTR", L"ASCIISTR", 8) == true)
    exists = ParseFunctionAsciistr(name, open);
  else if (name->Compare("ASEHOSTNAME", L"ASEHOSTNAME", 11) == true)
    exists = ParseFunctionAsehostname(name, open);
  else if (name->Compare("ASIN", L"ASIN", 4) == true)
    exists = ParseFunctionAsin(name, open);
  else if (name->Compare("ATAN", L"ATAN", 4) == true)
    exists = ParseFunctionAtan(name, open);
  else if (name->Compare("ATAN2", L"ATAN2", 5) == true)
    exists = ParseFunctionAtan2(name, open);
  else if (name->Compare("ATANH", L"ATANH", 5) == true)
    exists = ParseFunctionAtanh(name, open);
  else if (name->Compare("ATN2", L"ATN2", 4) == true)
    exists = ParseFunctionAtn2(name, open);
  else if (name->Compare("AVG", L"AVG", 3) == true)
    exists = ParseFunctionAvg(name, open);
  else if (name->Compare("BASE64_DECODE", L"BASE64_DECODE", 13) == true)
    exists = ParseFunctionBase64Decode(name, open);
  else if (name->Compare("BASE64_ENCODE", L"BASE64_ENCODE", 13) == true)
    exists = ParseFunctionBase64Encode(name, open);
  else if (name->Compare("BIGINT", L"BIGINT", 6) == true)
    exists = ParseFunctionBigint(name, open);
  else if (name->Compare("BIGINTTOHEX", L"BIGINTTOHEX", 11) == true)
    exists = ParseFunctionBiginttohex(name, open);
  else if (name->Compare("BIN_TO_NUM", L"BIN_TO_NUM", 10) == true)
    exists = ParseFunctionBinToNum(name, open);
  else if (name->Compare("BINTOSTR", L"BINTOSTR", 8) == true)
    exists = ParseFunctionBintostr(name, open);
  else if (name->Compare("BITAND", L"BITAND", 6) == true)
    exists = ParseFunctionBitand(name, open);
  else if (name->Compare("BITANDNOT", L"BITANDNOT", 9) == true)
    exists = ParseFunctionBitandnot(name, open);
  else if (name->Compare("BIT_LENGTH", L"BIT_LENGTH", 10) == true)
    exists = ParseFunctionBitLength(name, open);
  else if (name->Compare("BITNOT", L"BITNOT", 6) == true)
    exists = ParseFunctionBitnot(name, open);
  else if (name->Compare("BITOR", L"BITOR", 5) == true)
    exists = ParseFunctionBitor(name, open);
  else if (name->Compare("BIT_SUBSTR", L"BIT_SUBSTR", 10) == true)
    exists = ParseFunctionBitSubstr(name, open);
  else if (name->Compare("BITXOR", L"BITXOR", 6) == true)
    exists = ParseFunctionBitxor(name, open);
  else if (name->Compare("BLOB", L"BLOB", 4) == true)
    exists = ParseFunctionBlob(name, open);
  else if (name->Compare("BYTE_LENGTH", L"BYTE_LENGTH", 11) == true)
    exists = ParseFunctionByteLength(name, open);
  else if (name->Compare("BYTE_SUBSTR", L"BYTE_SUBSTR", 11) == true)
    exists = ParseFunctionByteSubstr(name, open);
  else if (name->Compare("CAST", L"CAST", 4) == true)
    exists = ParseFunctionCast(name, open);
  else if (name->Compare("CEIL", L"CEIL", 4) == true)
    exists = ParseFunctionCeil(name, open);
  else if (name->Compare("CEILING", L"CEILING", 7) == true)
    exists = ParseFunctionCeiling(name, open);
  else if (name->Compare("CHAR", L"CHAR", 4) == true)
    exists = ParseFunctionChar(name, open);
  else if (name->Compare("CHARACTER_LENGTH", L"CHARACTER_LENGTH", 16) == true ||
           name->Compare("CHAR_LENGTH", L"CHAR_LENGTH", 11) == true)
    exists = ParseFunctionCharacterLength(name, open);
  else if (name->Compare("CHARINDEX", L"CHARINDEX", 9) == true)
    exists = ParseFunctionCharindex(name, open);
  else if (name->Compare("CHR", L"CHR", 3) == true)
    exists = ParseFunctionChr(name, open);
  else if (name->Compare("CLOB", L"CLOB", 4) == true)
    exists = ParseFunctionClob(name, open);
  else if (name->Compare("COALESCE", L"COALESCE", 8) == true)
    exists = ParseFunctionCoalesce(name, open);
  else if (name->Compare("COL_LENGTH", L"COL_LENGTH", 10) == true)
    exists = ParseFunctionColLength(name, open);
  else if (name->Compare("COL_NAME", L"COL_NAME", 8) == true)
    exists = ParseFunctionColName(name, open);
  else if (name->Compare("COMPARE", L"COMPARE", 7) == true)
    exists = ParseFunctionCompare(name, open);
  else if (name->Compare("CONCAT", L"CONCAT", 6) == true)
    exists = ParseFunctionConcat(name, open);
  else if (name->Compare("CONVERT", L"CONVERT", 7) == true)
    exists = ParseFunctionConvert(name, open);
  else if (name->Compare("COS", L"COS", 3) == true)
    exists = ParseFunctionCos(name, open);
  else if (name->Compare("COSH", L"COSH", 4) == true)
    exists = ParseFunctionCosh(name, open);
  else if (name->Compare("COT", L"COT", 3) == true)
    exists = ParseFunctionCot(name, open);
  else if (name->Compare("COUNT", L"COUNT", 5) == true)
    exists = ParseFunctionCount(name, open);
  else if (name->Compare("CSCONVERT", L"CSCONVERT", 9) == true)
    exists = ParseFunctionCsconvert(name, open);
  else if (name->Compare("CURDATE", L"CURDATE", 7) == true)
    exists = ParseFunctionCurdate(name, open);
  else if (name->Compare("CURRENT_BIGDATETIME", L"CURRENT_BIGDATETIME", 19) ==
           true)
    exists = ParseFunctionCurrentBigdatetime(name, open);
  else if (name->Compare("CURRENT_BIGTIME", L"CURRENT_BIGTIME", 15) == true)
    exists = ParseFunctionCurrentBigtime(name, open);
  else if (name->Compare("CURRENT_DATE", L"CURRENT_DATE", 12) == true)
    exists = ParseFunctionCurrentDate(name, open);
  else if (name->Compare("CURRENT_TIMESTAMP", L"CURRENT_TIMESTAMP", 17) == true)
    exists = ParseFunctionCurrentTimestamp(name, open);
  else if (name->Compare("CURSOR_ROWCOUNT", L"CURSOR_ROWCOUNT", 15) == true)
    exists = ParseFunctionCursorRowcount(name, open);
  else if (name->Compare("DATALENGTH", L"DATALENGTH", 10) == true)
    exists = ParseFunctionDatalength(name, open);
  else if (name->Compare("DATE", L"DATE", 4) == true)
    exists = ParseFunctionDate(name, open);
  else if (name->Compare("DATEADD", L"DATEADD", 7) == true)
    exists = ParseFunctionDateadd(name, open);
  else if (name->Compare("DATEDIFF", L"DATEDIFF", 8) == true)
    exists = ParseFunctionDatediff(name, open);
  else if (name->Compare("DATE_FORMAT", L"DATE_FORMAT", 11) == true)
    exists = ParseFunctionDateFormat(name, open);
  else if (name->Compare("DATEFORMAT", L"DATEFORMAT", 10) == true)
    exists = ParseFunctionDateformatASA(name, open);
  else if (name->Compare("DATENAME", L"DATENAME", 8) == true)
    exists = ParseFunctionDatename(name, open);
  else if (name->Compare("DATEPART", L"DATEPART", 8) == true)
    exists = ParseFunctionDatepart(name, open);
  else if (name->Compare("DATE_SUB", L"DATE_SUB", 8) == true)
    exists = ParseFunctionDatesub(name, open);
  else if (name->Compare("DATETIME", L"DATETIME", 8) == true)
    exists = ParseFunctionDatetime(name, open);
  else if (name->Compare("DAY", L"DAY", 3) == true)
    exists = ParseFunctionDay(name, open);
  else if (name->Compare("DAYNAME", L"DAYNAME", 7) == true)
    exists = ParseFunctionDayname(name, open);
  else if (name->Compare("DAYOFMONTH", L"DAYOFMONTH", 10) == true)
    exists = ParseFunctionDayofmonth(name, open);
  else if (name->Compare("DAYOFWEEK", L"DAYOFWEEK", 9) == true)
    exists = ParseFunctionDayofweek(name, open);
  else if (name->Compare("DAYOFWEEK_ISO", L"DAYOFWEEK_ISO", 13) == true)
    exists = ParseFunctionDayofweekIso(name, open);
  else if (name->Compare("DAYOFYEAR", L"DAYOFYEAR", 9) == true)
    exists = ParseFunctionDayofyear(name, open);
  else if (name->Compare("DAYS", L"DAYS", 4) == true)
    exists = ParseFunctionDays(name, open);
  else if (name->Compare("DENSE_RANK", L"DENSE_RANK", 10) == true)
    exists = ParseFunctionDenseRank(name, open);
  else if (name->Compare("DBCLOB", L"DBCLOB", 6) == true)
    exists = ParseFunctionDbclob(name, open);
  else if (name->Compare("DB_ID", L"DB_ID", 5) == true)
    exists = ParseFunctionDbId(name, open);
  else if (name->Compare("DBINFO", L"DBINFO", 6) == true)
    exists = ParseFunctionDbinfo(name, open);
  else if (name->Compare("DB_INSTANCEID", L"DB_INSTANCEID", 13) == true)
    exists = ParseFunctionDbInstanceid(name, open);
  else if (name->Compare("DB_NAME", L"DB_NAME", 7) == true)
    exists = ParseFunctionDbName(name, open);
  else if (name->Compare("DECFLOAT", L"DECFLOAT", 8) == true)
    exists = ParseFunctionDecfloat(name, open);
  else if (name->Compare("DECFLOAT_FORMAT", L"DECFLOAT_FORMAT", 15) == true)
    exists = ParseFunctionDecfloatFormat(name, open);
  else if (name->Compare("DECIMAL", L"DECIMAL", 7) == true ||
           name->Compare("DEC", L"DEC", 3) == true)
    exists = ParseFunctionDecimal(name, open);
  else if (name->Compare("DECODE", L"DECODE", 6) == true)
    exists = ParseFunctionDecode(name, open);
  else if (name->Compare("DEGREES", L"DEGREES", 7) == true)
    exists = ParseFunctionDegrees(name, open);
  else if (name->Compare("DEREF", L"DEREF", 5) == true)
    exists = ParseFunctionDeref(name, open);
  else if (name->Compare("DIGITS", L"DIGITS", 6) == true)
    exists = ParseFunctionDigits(name, open);
  else if (name->Compare("DOUBLE", L"DOUBLE", 6) == true ||
           name->Compare("DOUBLE_PRECISION", L"DOUBLE_PRECISION", 16) == true)
    exists = ParseFunctionDouble(name, open);
  else if (name->Compare("DOW", L"DOW", 3) == true)
    exists = ParseFunctionDow(name, open);
  else if (name->Compare("EMPTY_BLOB", L"EMPTY_BLOB", 10) == true)
    exists = ParseFunctionEmptyBlob(name, open);
  else if (name->Compare("EMPTY_CLOB", L"EMPTY_CLOB", 10) == true)
    exists = ParseFunctionEmptyClob(name, open);
  else if (name->Compare("EMPTY_DBCLOB", L"EMPTY_DBCLOB", 12) == true)
    exists = ParseFunctionEmptyDbclob(name, open);
  else if (name->Compare("EMPTY_NCLOB", L"EMPTY_NCLOB", 11) == true)
    exists = ParseFunctionEmptyNclob(name, open);
  else if (name->Compare("ERRORMSG", L"ERRORMSG", 8) == true)
    exists = ParseFunctionErrormsg(name, open);
  else if (name->Compare("EXP", L"EXP", 3) == true)
    exists = ParseFunctionExp(name, open);
  else if (name->Compare("EXPRTYPE", L"EXPRTYPE", 3) == true)
    exists = ParseFunctionExprtype(name, open);
  else if (name->Compare("EXTRACT", L"EXTRACT", 7) == true)
    exists = ParseFunctionExtract(name, open);
  else if (name->Compare("FIRST", L"FIRST", 5) == true)
    exists = ParseFunctionFirst(name, open);
  else if (name->Compare("FLOAT", L"FLOAT", 5) == true)
    exists = ParseFunctionFloat(name, open);
  else if (name->Compare("FLOOR", L"FLOOR", 5) == true)
    exists = ParseFunctionFloor(name, open);
  else if (name->Compare("GET_BIT", L"GET_BIT", 7) == true)
    exists = ParseFunctionGetBit(name, open);
  else if (name->Compare("GETDATE", L"GETDATE", 7) == true)
    exists = ParseFunctionGetdate(name, open);
  else if (name->Compare("GETUTCDATE", L"GETUTCDATE", 10) == true)
    exists = ParseFunctionGetutcdate(name, open);
  else if (name->Compare("GREATER", L"GREATER", 7) == true)
    exists = ParseFunctionGreater(name, open);
  else if (name->Compare("GREATEST", L"GREATEST", 8) == true)
    exists = ParseFunctionGreatest(name, open);
  else if (name->Compare("HASH", L"HASH", 4) == true)
    exists = ParseFunctionHash(name, open);
  else if (name->Compare("HEX", L"HEX", 3) == true)
    exists = ParseFunctionHex(name, open);
  else if (name->Compare("HEXTOBIGINT", L"HEXTOBIGINT", 11) == true)
    exists = ParseFunctionHextobigint(name, open);
  else if (name->Compare("HEXTOINT", L"HEXTOINT", 8) == true)
    exists = ParseFunctionHextoint(name, open);
  else if (name->Compare("HEXTORAW", L"HEXTORAW", 8) == true)
    exists = ParseFunctionHextoraw(name, open);
  else if (name->Compare("HOST_ID", L"HOST_ID", 7) == true)
    exists = ParseFunctionHostId(name, open);
  else if (name->Compare("HOST_NAME", L"HOST_NAME", 9) == true)
    exists = ParseFunctionHostName(name, open);
  else if (name->Compare("HOUR", L"HOUR", 4) == true)
    exists = ParseFunctionHour(name, open);
  else if (name->Compare("HTML_DECODE", L"HTML_DECODE", 11) == true)
    exists = ParseFunctionHtmlDecode(name, open);
  else if (name->Compare("HTML_ENCODE", L"HTML_ENCODE", 11) == true)
    exists = ParseFunctionHtmlEncode(name, open);
  else if (name->Compare("HTTP_DECODE", L"HTTP_DECODE", 11) == true)
    exists = ParseFunctionHttpDecode(name, open);
  else if (name->Compare("HTTP_ENCODE", L"HTTP_ENCODE", 11) == true)
  ...
  else if (name->Compare("IFNULL", L"IFNULL", 6) == true)
    exists = ParseFunctionIfnull(name, open);
  else if (name->Compare("IIF", L"IIF", 3) == true)
    exists = ParseFunctionIif(name, open);
  else if (name->Compare("INDEX_COL", L"INDEX_COL", 9) == true)
    exists = ParseFunctionIndexCol(name, open);
  else if (name->Compare("INDEX_COLORDER", L"INDEX_COLORDER", 14) == true)
    exists = ParseFunctionIndexColorder(name, open);
  else if (name->Compare("INDEX_NAME", L"INDEX_NAME", 10) == true)
    exists = ParseFunctionIndexName(name, open);
  else if (name->Compare("INITCAP", L"INITCAP", 4) == true)
    exists = ParseFunctionInitcap(name, open);
  else if (name->Compare("INSERT", L"INSERT", 6) == true)
    exists = ParseFunctionInsert(name, open);
  else if (name->Compare("INSERTSTR", L"INSERTSTR", 9) == true)
    exists = ParseFunctionInsertstr(name, open);
  else if (name->Compare("INSTANCE_ID", L"INSTANCE_ID", 11) == true)
    exists = ParseFunctionInstanceId(name, open);
  else if (name->Compare("INSTANCE_NAME", L"INSTANCE_NAME", 13) == true)
    exists = ParseFunctionInstanceName(name, open);
  else if (name->Compare("INSTR", L"INSTR", 5) == true)
    exists = ParseFunctionInstr(name, open);
  else if (name->Compare("INSTRB", L"INSTRB", 6) == true)
    exists = ParseFunctionInstrb(name, open);
  else if (name->Compare("INTEGER", L"INTEGER", 7) == true ||
           name->Compare("INT", L"INT", 3) == true)
    exists = ParseFunctionInteger(name, open);
  else if (name->Compare("INTTOHEX", L"INTTOHEX", 8) == true)
    exists = ParseFunctionInttohex(name, open);
  else if (name->Compare("ISDATE", L"ISDATE", 6) == true)
    exists = ParseFunctionIsdate(name, open);
  else if (name->Compare("ISNULL", L"ISNULL", 6) == true)
    exists = ParseFunctionIsnull(name, open);
  else if (name->Compare("ISNUMERIC", L"ISNUMERIC", 9) == true)
    exists = ParseFunctionIsnumeric(name, open);
  else if (name->Compare("IS_SINGLEUSERMODE", L"IS_SINGLEUSERMODE", 17) == true)
    exists = ParseFunctionIsSingleusermode(name, open);
  else if (name->Compare("JULIAN_DAY", L"JULIAN_DAY", 10) == true)
    exists = ParseFunctionJulianDay(name, open);
  else if (name->Compare("LAST_DAY", L"LAST_DAY", 8) == true)
    exists = ParseFunctionLastDay(name, open);
  else if (name->Compare("LASTAUTOINC", L"LASTAUTOINC", 11) == true)
    exists = ParseFunctionLastAutoInc(name, open);
  else if (name->Compare("LCASE", L"LCASE", 5) == true)
    exists = ParseFunctionLcase(name, open);
  else if (name->Compare("LEAST", L"LEAST", 5) == true)
    exists = ParseFunctionLeast(name, open);
  else if (name->Compare("LEFT", L"LEFT", 4) == true)
    exists = ParseFunctionLeft(name, open);
  else if (name->Compare("LEN", L"LEN", 3) == true)
    exists = ParseFunctionLen(name, open);
  else if (name->Compare("LENGTH", L"LENGTH", 6) == true)
    exists = ParseFunctionLength(name, open);
  else if (name->Compare("LENGTHB", L"LENGTHB", 7) == true)
    exists = ParseFunctionLengthb(name, open);
  else if (name->Compare("LESSER", L"LESSER", 6) == true)
    exists = ParseFunctionLesser(name, open);
  else if (name->Compare("LIST", L"LIST", 4) == true)
    exists = ParseFunctionList(name, open);
  else if (name->Compare("LN", L"LN", 2) == true)
    exists = ParseFunctionLn(name, open);
  else if (name->Compare("LOCATE", L"LOCATE", 6) == true)
    exists = ParseFunctionLocate(name, open);
  else if (name->Compare("LOCATE_IN_STRING", L"LOCATE_IN_STRING", 16) == true)
    exists = ParseFunctionLocateInString(name, open);
  else if (name->Compare("LOG", L"LOG", 3) == true)
    exists = ParseFunctionLog(name, open);
  else if (name->Compare("LOG10", L"LOG10", 5) == true)
    exists = ParseFunctionLog10(name, open);
  else if (name->Compare("LONG_VARCHAR", L"LONG_VARCHAR", 12) == true)
    exists = ParseFunctionLongVarchar(name, open);
  else if (name->Compare("LONG_VARGRAPHIC", L"LONG_VARGRAPHIC", 15) == true)
    exists = ParseFunctionLongVargraphic(name, open);
  else if (name->Compare("LOWER", L"LOWER", 5) == true)
    exists = ParseFunctionLower(name, open);
  else if (name->Compare("LPAD", L"LPAD", 4) == true)
    exists = ParseFunctionLpad(name, open);
  else if (name->Compare("LTRIM", L"LTRIM", 5) == true)
    exists = ParseFunctionLtrim(name, open);
  else if (name->Compare("MAX", L"MAX", 3) == true)
    exists = ParseFunctionMax(name, open);
  else if (name->Compare("MDY", L"MDY", 3) == true)
    exists = ParseFunctionMdy(name, open);
  else if (name->Compare("MICROSECOND", L"MICROSECOND", 11) == true)
    exists = ParseFunctionMicrosecond(name, open);
  else if (name->Compare("MIDNIGHT_SECONDS", L"MIDNIGHT_SECONDS", 16) == true)
    exists = ParseFunctionMidnightSeconds(name, open);
  else if (name->Compare("MIN", L"MIN", 3) == true)
    exists = ParseFunctionMin(name, open);
  else if (name->Compare("MINUTE", L"MINUTE", 6) == true)
    exists = ParseFunctionMinute(name, open);
  else if (name->Compare("MOD", L"MOD", 3) == true)
    exists = ParseFunctionMod(name, open);
  else if (name->Compare("MONTH", L"MONTH", 5) == true)
    exists = ParseFunctionMonth(name, open);
  else if (name->Compare("MONTHNAME", L"MONTHNAME", 9) == true)
    exists = ParseFunctionMonthname(name, open);
  else if (name->Compare("MONTHS_BETWEEN", L"MONTHS_BETWEEN", 14) == true)
    exists = ParseFunctionMonthsBetween(name, open);
  else if (name->Compare("MULTIPLY_ALT", L"MULTIPLY_ALT", 12) == true)
    exists = ParseFunctionMultiplyAlt(name, open);
  else if (name->Compare("NCHAR", L"NCHAR", 5) == true)
    exists = ParseFunctionNchar(name, open);
  else if (name->Compare("NCLOB", L"NCLOB", 5) == true)
    exists = ParseFunctionNclob(name, open);
  else if (name->Compare("NEWID", L"NEWID", 5) == true)
    exists = ParseFunctionNewid(name, open);
  else if (name->Compare("NEWIDSTRING", L"NEWIDSTRING", 11) == true)
    exists = ParseFunctionNewidstring(name, open);
  else if (name->Compare("NEXT_DAY", L"NEXT_DAY", 8) == true)
    exists = ParseFunctionNextDay(name, open);
  else if (name->Compare("NEXT_IDENTITY", L"NEXT_IDENTITY", 13) == true)
    exists = ParseFunctionNextIdentity(name, open);
  else if (name->Compare("NOW", L"NOW", 3) == true)
    exists = ParseFunctionNow(name, open);
  else if (name->Compare("NULLIF", L"NULLIF", 6) == true)
    exists = ParseFunctionNullif(name, open);
  else if (name->Compare("NUMBER", L"NUMBER", 6) == true)
    exists = ParseFunctionNumber(name, open);
  else if (name->Compare("NVARCHAR", L"NVARCHAR", 8) == true)
    exists = ParseFunctionNvarchar(name, open);
  else if (name->Compare("NVL", L"NVL", 3) == true)
    exists = ParseFunctionNvl(name, open);
  else if (name->Compare("NVL2", L"NVL2", 4) == true)
    exists = ParseFunctionNvl2(name, open);
  else if (name->Compare("OBJECT_ID", L"OBJECT_ID", 9) == true)
    exists = ParseFunctionObjectId(name, open);
  else if (name->Compare("OBJECT_NAME", L"OBJECT_NAME", 11) == true)
    exists = ParseFunctionObjectName(name, open);
  else if (name->Compare("OBJECT_OWNER_ID", L"OBJECT_OWNER_ID", 15) == true)
    exists = ParseFunctionObjectOwnerId(name, open);
  else if (name->Compare("OCTET_LENGTH", L"OCTET_LENGTH", 12) == true)
    exists = ParseFunctionOctetLength(name, open);
  else if (name->Compare("OVERLAY", L"OVERLAY", 7) == true)
    exists = ParseFunctionOverlay(name, open);
  else if (name->Compare("PARTITION_ID", L"PARTITION_ID", 12) == true)
    exists = ParseFunctionPartitionId(name, open);
  else if (name->Compare("PARTITION_NAME", L"PARTITION_NAME", 14) == true)
    exists = ParseFunctionPartitionName(name, open);
  else if (name->Compare("PARTITION_OBJECT_ID", L"PARTITION_OBJECT_ID", 19) ==
           true)
    exists = ParseFunctionPartitionObjectId(name, open);
  else if (name->Compare("PASSWORD_RANDOM", L"PASSWORD_RANDOM", 15) == true)
    exists = ParseFunctionPasswordRandom(name, open);
  else if (name->Compare("PATINDEX", L"PATINDEX", 8) == true)
    exists = ParseFunctionPatindex(name, open);
  else if (name->Compare("PI", L"PI", 2) == true)
    exists = ParseFunctionPi(name, open);
  else if (name->Compare("POSITION", L"POSITION", 8) == true)
    exists = ParseFunctionPosition(name, open);
  else if (name->Compare("POSSTR", L"POSSTR", 6) == true)
    exists = ParseFunctionPosstr(name, open);
  else if (name->Compare("POWER", L"POWER", 5) == true)
    exists = ParseFunctionPower(name, open);
  else if (name->Compare("QUARTER", L"QUARTER", 7) == true)
    exists = ParseFunctionQuarter(name, open);
  else if (name->Compare("RADIANS", L"RADIANS", 7) == true)
    exists = ParseFunctionRadians(name, open);
  else if (name->Compare("RAISE_ERROR", L"RAISE_ERROR", 11) == true)
    exists = ParseFunctionRaiseError(name, open);
  else if (name->Compare("RAISERROR", L"RAISERROR", 9) == true)
    exists = ParseFunctionRaiserror(name, open);
  else if (name->Compare("RANK", L"RANK", 4) == true)
    exists = ParseFunctionRank(name, open);
  else if (name->Compare("RAND", L"RAND", 4) == true)
    exists = ParseFunctionRand(name, open);
  else if (name->Compare("RAND2", L"RAND2", 5) == true)
    exists = ParseFunctionRand2(name, open);
  else if (name->Compare("REAL", L"REAL", 4) == true)
    exists = ParseFunctionReal(name, open);
  else if (name->Compare("REGEXP_LIKE", L"REGEXP_LIKE", 11) == true)
    exists = ParseFunctionRegexpLike(name, open);
  else if (name->Compare("REGEXP_SUBSTR", L"REGEXP_SUBSTR", 13) == true)
    exists = ParseFunctionRegexpSubstr(name, open);
  else if (name->Compare("REMAINDER", L"REMAINDER", 9) == true)
    exists = ParseFunctionRemainder(name, open);
  else if (name->Compare("REPEAT", L"REPEAT", 6) == true)
    exists = ParseFunctionRepeat(name, open);
  else if (name->Compare("REPLACE", L"REPLACE", 7) == true)
    exists = ParseFunctionReplace(name, open);
  else if (name->Compare("REPLICATE", L"REPLICATE", 9) == true)
    exists = ParseFunctionReplicate(name, open);
  else if (name->Compare("RESERVE_IDENTITY", L"RESERVE_IDENTITY", 16) == true)
    exists = ParseFunctionReserveIdentity(name, open);
  else if (name->Compare("REVERSE", L"REVERSE", 7) == true)
    exists = ParseFunctionReverse(name, open);
  else if (name->Compare("RIGHT", L"RIGHT", 5) == true)
    exists = ParseFunctionRight(name, open);
  else if (name->Compare("ROUND", L"ROUND", 5) == true)
    exists = ParseFunctionRound(name, open);
  else if (name->Compare("ROUND_TIMESTAMP", L"ROUND_TIMESTAMP", 15) == true)
    exists = ParseFunctionRoundTimestamp(name, open);
  else if (name->Compare("ROW_NUMBER", L"ROW_NUMBER", 10) == true)
    exists = ParseFunctionRowNumber(name, open);
  else if (name->Compare("RPAD", L"RPAD", 4) == true)
    exists = ParseFunctionRpad(name, open);
  else if (name->Compare("RTRIM", L"RTRIM", 5) == true)
  ...
  else if (name->Compare("SECOND", L"SECOND", 6) == true)
    exists = ParseFunctionSecond(name, open);
  else if (name->Compare("SIGN", L"SIGN", 4) == true)
    exists = ParseFunctionSign(name, open);
  else if (name->Compare("SIN", L"SIN", 3) == true)
    exists = ParseFunctionSin(name, open);
  else if (name->Compare("SINH", L"SINH", 4) == true)
    exists = ParseFunctionSinh(name, open);
  else if (name->Compare("SMALLINT", L"SMALLINT", 8) == true)
    exists = ParseFunctionSmallint(name, open);
  else if (name->Compare("SOUNDEX", L"SOUNDEX", 7) == true)
    exists = ParseFunctionSoundex(name, open);
  else if (name->Compare("SPACE", L"SPACE", 5) == true)
    exists = ParseFunctionSpace(name, open);
  else if (name->Compare("SPID_INSTANCE_ID", L"SPID_INSTANCE_ID", 16) == true)
    exists = ParseFunctionSpidInstanceId(name, open);
  else if (name->Compare("SQLERRM", L"SQLERRM", 7) == true)
    exists = ParseFunctionSqlerrm(name, open);
  else if (name->Compare("SQRT", L"SQRT", 4) == true)
    exists = ParseFunctionSqrt(name, open);
  else if (name->Compare("SQUARE", L"SQUARE", 6) == true)
    exists = ParseFunctionSquare(name, open);
  else if (name->Compare("STR", L"STR", 3) == true)
    exists = ParseFunctionStr(name, open);
  else if (name->Compare("STRING", L"STRING", 6) == true)
    exists = ParseFunctionString(name, open);
  else if (name->Compare("STRIP", L"STRIP", 5) == true)
    exists = ParseFunctionStrip(name, open);
  else if (name->Compare("STR_REPLACE", L"STR_REPLACE", 11) == true)
    exists = ParseFunctionStrReplace(name, open);
  else if (name->Compare("STRTOBIN", L"STRTOBIN", 11) == true)
    exists = ParseFunctionStrtobin(name, open);
  else if (name->Compare("STUFF", L"STUFF", 5) == true)
    exists = ParseFunctionStuff(name, open);
  else if (name->Compare("SUBDATE", L"SUBDATE", 7) == true)
    exists = ParseFunctionSubdate(name, open);
  else if (name->Compare("SUBSTR", L"SUBSTR", 6) == true)
    exists = ParseFunctionSubstr(name, open);
  else if (name->Compare("SUBSTR2", L"SUBSTR2", 7) == true)
    exists = ParseFunctionSubstr2(name, open);
  else if (name->Compare("SUBSTRB", L"SUBSTRB", 7) == true)
    exists = ParseFunctionSubstrb(name, open);
  else if (name->Compare("SUBSTRING", L"SUBSTRING", 9) == true)
    exists = ParseFunctionSubstring(name, open);
  else if (name->Compare("SUM", L"SUM", 3) == true)
    exists = ParseFunctionSum(name, open);
  else if (name->Compare("SUSER_ID", L"SUSER_ID", 8) == true)
    exists = ParseFunctionSuserId(name, open);
  else if (name->Compare("SUSER_NAME", L"SUSER_NAME", 10) == true)
    exists = ParseFunctionSuserName(name, open);
  else if (name->Compare("SWITCHOFFSET", L"SWITCHOFFSET", 12) == true)
    exists = ParseFunctionSwitchoffset(name, open);
  else if (name->Compare("SYSDATETIMEOFFSET", L"SYSDATETIMEOFFSET", 17) == true)
    exists = ParseFunctionSysdatetimeoffset(name, open);
  else if (name->Compare("SYS_CONTEXT", L"SYS_CONTEXT", 11) == true)
    exists = ParseFunctionSysContext(name, open);
  else if (name->Compare("SYS_GUID", L"SYS_GUID", 8) == true)
    exists = ParseFunctionSysGuid(name, open);
  else if (name->Compare("TAN", L"TAN", 3) == true)
    exists = ParseFunctionTan(name, open);
  else if (name->Compare("TANH", L"TANH", 4) == true)
    exists = ParseFunctionTanh(name, open);
  else if (name->Compare("TEXTPTR", L"TEXTPTR", 7) == true)
    exists = ParseFunctionTextptr(name, open);
  else if (name->Compare("TEXTVALID", L"TEXTVALID", 9) == true)
    exists = ParseFunctionTextvalid(name, open);
  else if (name->Compare("TIME", L"TIME", 4) == true)
    exists = ParseFunctionTime(name, open);
  else if (name->Compare("TIMESTAMP", L"TIMESTAMP", 9) == true)
    exists = ParseFunctionTimestamp(name, open);
  else if (name->Compare("TIMESTAMPADD", L"TIMESTAMPADD", 12) == true)
    exists = ParseFunctionTimestampadd(name, open);
  else if (name->Compare("TIMESTAMPDIFF", L"TIMESTAMPDIFF", 13) == true)
    exists = ParseFunctionTimestampdiff(name, open);
  else if (name->Compare("TIMESTAMP_FORMAT", L"TIMESTAMP_FORMAT", 16) == true)
    exists = ParseFunctionTimestampFormat(name, open);
  else if (name->Compare("TIMESTAMP_ISO", L"TIMESTAMP_ISO", 13) == true)
    exists = ParseFunctionTimestampIso(name, open);
  else if (name->Compare("TO_CHAR", L"TO_CHAR", 7) == true)
    exists = ParseFunctionToChar(name, open);
  else if (name->Compare("TO_CLOB", L"TO_CLOB", 7) == true)
    exists = ParseFunctionToClob(name, open);
  else if (name->Compare("TO_DATE", L"TO_DATE", 7) == true)
    exists = ParseFunctionToDate(name, open);
  else if (name->Compare("TODATETIMEOFFSET", L"TODATETIMEOFFSET", 16) == true)
    exists = ParseFunctionTodatetimeoffset(name, open);
  else if (name->Compare("TODAY", L"TODAY", 5) == true)
    exists = ParseFunctionToday(name, open);
  else if (name->Compare("TO_LOB", L"TO_LOB", 6) == true)
    exists = ParseFunctionToLob(name, open);
  else if (name->Compare("TO_NCHAR", L"TO_NCHAR", 8) == true)
    exists = ParseFunctionToNchar(name, open);
  else if (name->Compare("TO_NCLOB", L"TO_NCLOB", 8) == true)
    exists = ParseFunctionToNclob(name, open);
  else if (name->Compare("TO_NUMBER", L"TO_NUMBER", 9) == true)
    exists = ParseFunctionToNumber(name, open);
  else if (name->Compare("TO_SINGLE_BYTE", L"TO_SINGLE_BYTE", 14) == true)
    exists = ParseFunctionToSingleByte(name, open);
  else if (name->Compare("TO_TIMESTAMP", L"TO_TIMESTAMP", 12) == true)
    exists = ParseFunctionToTimestamp(name, open);
  else if (name->Compare("TO_TIMESTAMP_TZ", L"TO_TIMESTAMP_TZ", 15) == true)
    exists = ParseFunctionToTimestampTz(name, open);
  else if (name->Compare("TO_UNICHAR", L"TO_UNICHAR", 10) == true)
    exists = ParseFunctionToUnichar(name, open);
  else if (name->Compare("TRANSLATE", L"TRANSLATE", 9) == true)
    exists = ParseFunctionTranslate(name, open);
  else if (name->Compare("TRIM", L"TRIM", 4) == true)
    exists = ParseFunctionTrim(name, open);
  else if (name->Compare("TRUNC", L"TRUNC", 5) == true)
    exists = ParseFunctionTrunc(name, open);
  else if (name->Compare("TRUNCATE", L"TRUNCATE", 8) == true)
    exists = ParseFunctionTruncate(name, open);
  else if (name->Compare("TRUNCNUM", L"TRUNCNUM", 8) == true)
    exists = ParseFunctionTruncnum(name, open);
  else if (name->Compare("TRUNC_TIMESTAMP", L"TRUNC_TIMESTAMP", 15) == true)
    exists = ParseFunctionTruncTimestamp(name, open);
  else if (name->Compare("TSEQUAL", L"TSEQUAL", 7) == true)
    exists = ParseFunctionTsequal(name, open);
  else if (name->Compare("UCASE", L"UCASE", 5) == true)
    exists = ParseFunctionUcase(name, open);
  else if (name->Compare("UHIGHSURR", L"UHIGHSURR", 9) == true)
    exists = ParseFunctionUhighsurr(name, open);
  else if (name->Compare("ULOWSURR", L"ULOWSURR", 8) == true)
    exists = ParseFunctionUlowsurr(name, open);
  else if (name->Compare("UNICODE", L"UNICODE", 7) == true)
    exists = ParseFunctionUnicode(name, open);
  else if (name->Compare("UNISTR", L"UNISTR", 6) == true)
    exists = ParseFunctionUnistr(name, open);
  else if (name->Compare("UPPER", L"UPPER", 5) == true)
    exists = ParseFunctionUpper(name, open);
  else if (name->Compare("USCALAR", L"USCALAR", 7) == true)
    exists = ParseFunctionUscalar(name, open);
  else if (name->Compare("USER_ID", L"USER_ID", 7) == true)
    exists = ParseFunctionUserId(name, open);
  else if (name->Compare("USERENV", L"USERENV", 7) == true)
    exists = ParseFunctionUserenv(name, open);
  else if (name->Compare("USER_NAME", L"USER_NAME", 9) == true)
    exists = ParseFunctionUserName(name, open);
  else if (name->Compare("VALUE", L"VALUE", 5) == true)
    exists = ParseFunctionValue(name, open);
  else if (name->Compare("VARCHAR", L"VARCHAR", 7) == true)
    exists = ParseFunctionVarchar(name, open);
  else if (name->Compare("VARCHAR_BIT_FORMAT", L"VARCHAR_BIT_FORMAT", 18) ==
           true)
    exists = ParseFunctionVarcharBitFormat(name, open);
  else if (name->Compare("VARCHAR_FORMAT", L"VARCHAR_FORMAT", 14) == true)
    exists = ParseFunctionVarcharFormat(name, open);
  else if (name->Compare("VARCHAR_FORMAT_BIT", L"VARCHAR_FORMAT_BIT", 18) ==
           true)
    exists = ParseFunctionVarcharFormatBit(name, open);
  else if (name->Compare("VARGRAPHIC", L"VARGRAPHIC", 10) == true)
    exists = ParseFunctionVargraphic(name, open);
  else if (name->Compare("VSIZE", L"VSIZE", 5) == true)
    exists = ParseFunctionVsize(name, open);
  else if (name->Compare("WEEK", L"WEEK", 4) == true)
    exists = ParseFunctionWeek(name, open);
  else if (name->Compare("WEEK_ISO", L"WEEK_ISO", 8) == true)
    exists = ParseFunctionWeekIso(name, open);
  else if (name->Compare("XMLAGG", L"XMLAGG", 6) == true)
    exists = ParseFunctionXmlagg(name, open);
  else if (name->Compare("XMLATTRIBUTES", L"XMLATTRIBUTES", 13) == true)
    exists = ParseFunctionXmlattributes(name, open);
  else if (name->Compare("XMLCAST", L"XMLCAST", 7) == true)
    exists = ParseFunctionXmlcast(name, open);
  else if (name->Compare("XMLCDATA", L"XMLCDATA", 8) == true)
    exists = ParseFunctionXmlcdata(name, open);
  else if (name->Compare("XMLCOMMENT", L"XMLCOMMENT", 10) == true)
    exists = ParseFunctionXmlcomment(name, open);
  else if (name->Compare("XMLCONCAT", L"XMLCONCAT", 9) == true)
    exists = ParseFunctionXmlconcat(name, open);
  else if (name->Compare("XMLDIFF", L"XMLDIFF", 7) == true)
    exists = ParseFunctionXmldiff(name, open);
  else if (name->Compare("XMLDOCUMENT", L"XMLDOCUMENT", 11) == true)
    exists = ParseFunctionXmldocument(name, open);
  else if (name->Compare("XMLELEMENT", L"XMLELEMENT", 10) == true)
    exists = ParseFunctionXmlelement(name, open);
  else if (name->Compare("XMLEXTRACT", L"XMLEXTRACT", 10) == true)
    exists = ParseFunctionXmlextract(name, open);
  else if (name->Compare("XMLFOREST", L"XMLFOREST", 9) == true)
    exists = ParseFunctionXmlforest(name, open);
  else if (name->Compare("XMLGEN", L"XMLGEN", 6) == true)
    exists = ParseFunctionXmlgen(name, open);
  else if (name->Compare("XMLISVALID", L"XMLISVALID", 10) == true)
    exists = ParseFunctionXmlisvalid(name, open);
  else if (name->Compare("XMLNAMESPACES", L"XMLNAMESPACES", 13) == true)
    exists = ParseFunctionXmlnamespaces(name, open);
  else if (name->Compare("XMLPARSE", L"XMLPARSE", 8) == true)
    exists = ParseFunctionXmlparse(name, open);
  else if (name->Compare("XMLPATCH", L"XMLPATCH", 8) == true)
    exists = ParseFunctionXmlpatch(name, open);
  else if (name->Compare("XMLPI", L"XMLPI", 5) == true)
    exists = ParseFunctionXmlpi(name, open);
  else if (name->Compare("XMLQUERY", L"XMLQUERY", 8) == true)
    exists = ParseFunctionXmlquery(name, open);
  else if (name->Compare("XMLREPRESENTATION", L"XMLREPRESENTATION", 17) == true)
    exists = ParseFunctionXmlrepresentation(name, open);
  else if (name->Compare("XMLROOT", L"XMLROOT", 7) == true)
    exists = ParseFunctionXmlroot(name, open);
  else if (name->Compare("XMLROW", L"XMLROW", 6) == true)
    exists = ParseFunctionXmlrow(name, open);
  else if (name->Compare("XMLSEQUENCE", L"XMLSEQUENCE", 11) == true)
    exists = ParseFunctionXmlsequence(name, open);
  else if (name->Compare("XMLSERIALIZE", L"XMLSERIALIZE", 12) == true)
    exists = ParseFunctionXmlserialize(name, open);
  else if (name->Compare("XMLTEXT", L"XMLTEXT", 7) == true)
    exists = ParseFunctionXmltext(name, open);
  else if (name->Compare("XMLTRANSFORM", L"XMLTRANSFORM", 12) == true)
    exists = ParseFunctionXmltransform(name, open);
  else if (name->Compare("XMLVALIDATE", L"XMLVALIDATE", 11) == true)
    exists = ParseFunctionXmlvalidate(name, open);
  else if (name->Compare("XMLXSROBJECTID", L"XMLXSROBJECTID", 14) == true)
    exists = ParseFunctionXmlxsrobjectid(name, open);
  else if (name->Compare("XSLTRANSFORM", L"XSLTRANSFORM", 12) == true)
    exists = ParseFunctionXsltransform(name, open);
  else if (name->Compare("YEAR", L"YEAR", 4) == true)
    exists = ParseFunctionYear(name, open);
  else if (name->Compare("ZEROIFNULL", L"ZEROIFNULL", 10) == true)
...
bool SqlParser::ParseFunctionWithoutParameters(Token *name) {
  ...
  else if (name->Compare("CURRENT", L"CURRENT", 7) == true)
    exists = ParseFunctionCurrent(name);
  else if (name->Compare("CURRENT_DATE", L"CURRENT_DATE", 12) == true)
    exists = ParseFunctionCurrentDate(name);
  else if (name->Compare("CURRENT_SCHEMA", L"CURRENT_SCHEMA", 14) == true)
    exists = ParseFunctionCurrentSchema(name);
  else if (name->Compare("CURRENT_SQLID", L"CURRENT_SQLID", 13) == true)
    exists = ParseFunctionCurrentSqlid(name);
  else if (name->Compare("CURRENT_TIMESTAMP", L"CURRENT_TIMESTAMP", 17) == true)
    exists = ParseFunctionCurrentTimestamp(name);
  else if (name->Compare("CURRENT_TIME", L"CURRENT_TIME", 12) == true)
    exists = ParseFunctionCurrentTime(name);
  else if (name->Compare("CURRENT_USER", L"CURRENT_USER", 12) == true)
    exists = ParseFunctionCurrentUser(name);
  else if (name->Compare("DATE", L"DATE", 4) == true)
    exists = ParseFunctionDate(name);
  else if (name->Compare("@@IDENTITY", L"@@IDENTITY", 10) == true)
    exists = ParseFunctionIdentity(name);
  else if (name->Compare("INTERVAL", L"INTERVAL", 8) == true)
    exists = ParseFunctionInterval(name);
  else if (name->Compare("LOCALTIMESTAMP", L"LOCALTIMESTAMP", 14) == true)
    exists = ParseFunctionLocaltimestamp(name);
  else if (name->Compare("NEXTVAL", L"NEXTVAL", 7) == true)
    exists = ParseFunctionNextval(name);
  else if (name->Compare("@@ROWCOUNT", L"@@ROWCOUNT", 10) == true)
    exists = ParseFunctionRowcount(name);
  else if (name->Compare("SQLCODE", L"SQLCODE", 7) == true)
    exists = ParseFunctionSqlcode(name);
  else if (name->Compare("SQLERRM", L"SQLERRM", 7) == true)
    exists = ParseFunctionSqlerrm(name, NULL);
  else if (name->Compare("SQLSTATE", L"SQLSTATE", 8) == true)
    exists = ParseFunctionSqlstate(name);
  else
    // SQL%ROWCOUNT
    if (name->Compare("SQL", L"SQL", 3) == true)
      exists = ParseFunctionSqlPercent(name);
    else if (name->Compare("SYSDATE", L"SYSDATE", 7) == true)
      exists = ParseFunctionSysdate(name);
    else if (name->Compare("SYSTEM_USER", L"SYSTEM_USER", 11) == true)
      exists = ParseFunctionSystemUser(name);
    else if (name->Compare("SYSTIMESTAMP", L"SYSTIMESTAMP", 12) == true)
      exists = ParseFunctionSystimestamp(name);
    else if (name->Compare("TIME", L"TIME", 4) == true)
      exists = ParseFunctionTime(name);
    else if (name->Compare("TODAY", L"TODAY", 5) == true)
      exists = ParseFunctionToday(name);
    else if (name->Compare("USER", L"USER", 4) == true)
      exists = ParseFunctionUser(name);
    else if (name->Compare("_UTF8", L"_UTF8", 5) == true)
...
bool SqlParser::ParseFunctionAsehostname(Token *name, Token *open) {
  ...
  if (_target == SQL_SQL_SERVER)
    ...
    if (_target == SQL_ORACLE) {
      Token::Change(name, "SYS_CONTEXT('USERENV', 'SERVER_HOST'",
                    L"SYS_CONTEXT('USERENV', 'SERVER_HOST'", 36);
      Token::Remove(open);
    } else if (Target(SQL_MYSQL, SQL_MARIADB)) {
...
bool SqlParser::ParseFunctionBase64Decode(Token *name, Token * /*open*/) {
  ...
  if (_target == SQL_ORACLE) {
    Prepend(name, "UTL_RAW.CAST_TO_VARCHAR2(UTL_ENCODE.",
            L"UTL_RAW.CAST_TO_VARCHAR2(UTL_ENCODE.", 36, name);
...
bool SqlParser::ParseFunctionBiginttohex(Token *name, Token * /*open*/) {
  ...
  if (_target == SQL_SQL_SERVER) {
    Token::Change(name, "CONVERT(VARBINARY(8), CAST(",
                  L"CONVERT(VARBINARY(8), CAST(", 26);
    Prepend(close, " AS BIGINT)", L" AS BIGINT)", 11);
  } else
    // Convert to TO_CHAR in Oracle
    if (_target == SQL_ORACLE) {
      Token::Change(name, "TO_CHAR(ABS", L"TO_CHAR(ABS", 11);
      Prepend(close, "), 'XXXXXXXXXXXXXXXXXXX'", L"), 'XXXXXXXXXXXXXXXXXXX'",
              24);
    } else if (Target(SQL_MYSQL, SQL_MARIADB)) {
  ...
  if (type->Compare("VARCHAR", L"VARCHAR", 7) == true) {
    ...
    if (type->Compare("DATE", L"DATE", 4) == true) {
      if (_source != SQL_ORACLE && _target == SQL_ORACLE) {
        ...
        // If string litral is specified try to recognize format, and convert to
        // TO_DATE
        if (exp->type == TOKEN_STRING &&
            RecognizeOracleDateFormat(exp, format) == true) {
...
bool SqlParser::ParseFunctionChar(Token *name, Token *open) {
  ...
  // Do not check that previous is a word as SELECT CHAR(), THEN CHAR etc. are
  // possible
  ...
  if (_source == SQL_DB2) {
    if (format != NULL) {
      // If a number constant it is CHAR(string, num) - truncate or right pad
      // string to num
      if (format->IsNumeric() == true) {
        ...
        if (format->Compare("ISO", L"ISO", 3) ||
            format->Compare("JIS", L"JIS", 3)) {
          if (_target == SQL_SQL_SERVER) {
          ...
          if (format->Compare("USA", L"USA", 3) == true) {
            ...
            } else if (_target == SQL_SQL_SERVER) {
              TOKEN_CHANGE(name, "CONVERT");
              APPEND_FIRST_FMT(open, "VARCHAR, ", name);
...
bool SqlParser::ParseFunctionConcat(Token *concat, Token *open) {
  ...
  while (true) {
    ...
    // Oracle supports only 2 parameters in CONCAT, replace function with ||
    // operator
    if (_target == SQL_ORACLE)
...
bool SqlParser::ParseFunctionConvert(Token *name, Token *open) {
  ...
  STATS_DECL
  // First is a keyword specifying data type in SQL Server, Sybase ASE, Sybase
  // ASA
  ...
  else if (TOKEN_CMP(datatype, "IMAGE"))
    ParseFunctionConvertImage(name, open, datatype);
  else if (TOKEN_CMP(datatype, "INTEGER"))
    ParseFunctionConvertInteger(name, open, datatype);
  else if (TOKEN_CMP(datatype, "TEXT"))
    ParseFunctionConvertText(name, open, datatype);
  else if (TOKEN_CMP(datatype, "VARCHAR") || TOKEN_CMP(datatype, "CHAR"))
...
bool SqlParser::ParseFunctionConvertMySql(Token *name, Token * /*open*/) {
  ...
  if (_source == SQL_SYBASE_ADS) {
    ...
    else if (TOKEN_CMP(datatype, "SQL_DATE"))
      TOKEN_CHANGE(datatype, "DATE");
    else if (TOKEN_CMP(datatype, "SQL_INTEGER"))
      TOKEN_CHANGE(datatype, "INTEGER");
    else if (TOKEN_CMP(datatype, "SQL_TIME")) {
      if (_target == SQL_SQL_SERVER)
  ...
  // Other databases use different order in CONVERT; Oracle does not support
...
bool SqlParser::ParseFunctionConvertDatetime(Token *name, Token *open,
                                             Token *datatype) {
  STATS_DECL
  Token *comma = GetNextCharToken(',', L',');
  ...
  if (Target(SQL_MARIADB, SQL_MYSQL)) {
    ...
    if (style != NULL) {
      ...
      if (_source == SQL_SQL_SERVER) {
        ...
        else if (style->Compare("121", L"121", 3) == true)
          Token::Change(style, "'%Y-%m-%d %T.%f'", L"'%Y-%m-%d %T.%f'", 16);
      } else if (_source == SQL_SYBASE)
    ...
    // Use the default format for datetime and CONVERT(exp, datatype) function
      ...
      // Specify datatype explicitly as the source can be SMALLDATETIME or other
      // datetime type
...
bool SqlParser::ParseFunctionConvertImage(Token *name, Token *open,
                                          Token *datatype) {
  STATS_DECL
...
bool SqlParser::ParseFunctionConvertInteger(Token *name, Token *open,
                                            Token * /*datatype*/) {
  STATS_DECL
  // Comma after the data type
  Token *comma = GetNextCharToken(',', L',');
...
bool SqlParser::ParseFunctionConvertText(Token *name, Token *open,
                                         Token *datatype) {
  STATS_DECL
  // Comma after the data type
  Token *comma = GetNextCharToken(',', L',');
...
bool SqlParser::ParseFunctionConvertVarchar(Token *name, Token *open,
                                            Token *datatype) {
  STATS_DECL
  ...
  if (Target(SQL_ORACLE, SQL_POSTGRESQL) == true) {
    ...
    if (Target(SQL_MARIADB, SQL_MYSQL) &&
      ...
      if (style != NULL && _source == SQL_SQL_SERVER) {
        if (style->Compare("101", L"101", 3) == true)
          Token::Change(style, "'%m/%d/%Y'", L"'%m/%d/%Y'", 10);
        else if (style->Compare("103", L"103", 3) == true)
          Token::Change(style, "'%d/%m/%Y'", L"'%d/%m/%Y'", 10);
        else if (style->Compare("108", L"108", 3) == true)
          Token::Change(style, "'%T'", L"'%T'", 4);
        else if (style->Compare("112", L"112", 3) == true)
          Token::Change(style, "'%Y%m%d'", L"'%Y%m%d'", 8);
        else if (style->Compare("121", L"121", 3) == true)
          Token::Change(style, "'%Y-%m-%d %T.%f'", L"'%Y-%m-%d %T.%f'", 16);
        else if (style->Compare("20", L"20", 2) == true)
      ...
      if (exp->data_type == TOKEN_DT_STRING) {
        // CAST(exp AS CHAR(length)) for MariaDB, MySQL; they do not support
        // CAST AS VARCHAR
        if (Target(SQL_MARIADB, SQL_MYSQL)) {
...
// CURRENT DATE, CURRENT SERVER, CURRENT SCHEMA, CURRENT SQLID, CURRENT TIME,
// CURRENT TIMESTAMP, CURRENT USER, Informix CURRENT YEAR TO SECOND
bool SqlParser::ParseFunctionCurrent(Token *name) {
  ...
  if (second->Compare("DATE", L"DATE", 4) == true) {
    if (_target == SQL_SQL_SERVER) {
      Token::Change(name, "CONVERT(DATE, GETDATE())",
                    L"CONVERT(DATE, GETDATE())", 24);
      Token::Remove(second);
    } else if (_target == SQL_ORACLE) {
      Token::Change(name, "TRUNC(SYSDATE)", L"TRUNC(SYSDATE)", 14);
      Token::Remove(second);
    } else if (Target(SQL_MARIADB, SQL_MYSQL) || _target == SQL_POSTGRESQL ||
               _target == SQL_GREENPLUM) {
    ...
    if (second->Compare("SCHEMA", L"SCHEMA", 6) == true) {
      ...
      if (second->Compare("SERVER", L"SERVER", 6) == true) {
        if (_target == SQL_ORACLE) {
          Token::Change(name, "SYS_CONTEXT('USERENV', 'DB_NAME')",
                        L"SYS_CONTEXT('USERENV', 'DB_NAME')", 33);
          Token::Remove(second);
        }
        ...
        if (second->Compare("SQLID", L"SQLID", 5) == true) {
          ...
          if (second->Compare("TIMESTAMP", L"TIMESTAMP", 9) == true) {
            ...
            if (_target == SQL_ORACLE) {
              ...
              if (_target == SQL_SQL_SERVER) {
                ...
                if (Target(SQL_MARIADB, SQL_MYSQL, SQL_POSTGRESQL,
                           SQL_GREENPLUM)) {
                  Token::Change(second, "CURRENT_TIMESTAMP",
                                L"CURRENT_TIMESTAMP", 17);
                  Token::Remove(name);
                }
            ...
            if (second->Compare("TIME", L"TIME", 4) == true) {
              if (_target == SQL_SQL_SERVER) {
                Token::Change(name, "CONVERT(TIME, GETDATE())",
                              L"CONVERT(TIME, GETDATE())", 24);
                Token::Remove(second);
              } else if (_target == SQL_ORACLE) {
                Token::Change(name, "CURRENT_TIMESTAMP", L"CURRENT_TIMESTAMP",
                              17);
                Token::Remove(second);
              }
...
bool SqlParser::ParseFunctionCurrentBigdatetime(Token *name, Token *open) {
  ...
  if (_target == SQL_SQL_SERVER)
    ...
    if (_target == SQL_ORACLE) {
      ...
      Token::Remove(open, close);
    } else if (Target(SQL_MARIADB, SQL_MYSQL)) {
...
bool SqlParser::ParseFunctionCurrentDate(Token *name, Token *open) {
  ...
  // If target type is not MariaDB, MySQL, Sybase ASE, Sybase ADS remove
  // parentheses
...
bool SqlParser::ParseFunctionCurrentTime(Token *name) {
  ...
  // Oracle you can declare a variable CURRENT_TIME, there is no such built-in
  // function
  if (_source == SQL_ORACLE)
    return false;
...
bool SqlParser::ParseFunctionDateadd(Token *name, Token *open) {
  ...
  // PostgreSQL
  if (_target == SQL_POSTGRESQL) {
    // If a numeric constant is specified, convert to "INTERVAL 'number part' +
    // datetime"
    ...
    // If an expression is specified, convert to "exp * INTERVAL '1 part' +
    // datetime"
    {
    ...
    if (_target == SQL_ORACLE) {
      ...
      if (Target(SQL_MYSQL, SQL_MARIADB)) {
        ...
        else if (TOKEN_CMP(datepart, "qq"))
          TOKEN_CHANGE(datepart, "quarter");
        else if (TOKEN_CMP(datepart, "mm"))
          TOKEN_CHANGE(datepart, "month");
        else if (TOKEN_CMP(datepart, "wk"))
          TOKEN_CHANGE(datepart, "week");
        else if (TOKEN_CMP(datepart, "dd") || TOKEN_CMP(datepart, "dy") ||
                 TOKEN_CMP(datepart, "dw") ||
                 TOKEN_CMP(datepart, "dayofyear") ||
                 TOKEN_CMP(datepart, "weekday"))
          TOKEN_CHANGE(datepart, "day");
        else if (TOKEN_CMP(datepart, "hh"))
          TOKEN_CHANGE(datepart, "hour");
        else if (TOKEN_CMP(datepart, "mi"))
          TOKEN_CHANGE(datepart, "minute");
        else if (TOKEN_CMP(datepart, "ss"))
          TOKEN_CHANGE(datepart, "second");
        else if (TOKEN_CMP(datepart, "ms") ||
                 TOKEN_CMP(datepart, "millisecond")) {
...
bool SqlParser::ParseFunctionDatediff(Token *name, Token *open) {
  ...
  STATS_DECL
  // In SQL Server, Sybase ASE and Sybase ASA first parameter specifies unit, in
  // MySQL difference always in days
  Token *datepart = NULL;
  Token *comma1 = NULL;
      ...
      if (Token::Compare(datepart, "MONTH", L"MONTH", 5) ||
        ...
        if (Token::Compare(datepart, "YEAR", L"YEAR", 4) ||
          ...
          if (Token::Compare(datepart, "DAY", L"DAY", 3) ||
            ...
            // If datepart is HOUR convert to (enddate - startdate) * 24 in
            // Oracle
            if (Token::Compare(datepart, "HOUR", L"HOUR", 4) ||
              ...
              // If datepart is MINUTE convert to (enddate - startdate) * 1440
              // in Oracle
              if (Token::Compare(datepart, "MINUTE", L"MINUTE", 6) ||
                  Token::Compare(datepart, "MI", L"MI", 2)) {
                // If start and end are date string literals enclose with
                // TO_DATE
                if (end->type == TOKEN_STRING) {
                  Append(open, "TO_DATE(", L"TO_DATE(", 8, name);
                  AppendCopy(open, end);
                ...
                // If datepart is SECOND convert to (enddate - startdate) *
                // 86400 in Oracle
      ...
      if (_target == SQL_ORACLE)
        ...
        if (_target == SQL_SQL_SERVER) {
          ...
          if (format->Compare("'YYYY-MM-DD'", L"'YYYY-MM-DD'", 12) == true) {
            Token::Change(name, "CONVERT(VARCHAR(10), ",
                          L"CONVERT(VARCHAR(10), ", 21);
            Token::Remove(open);
            Token::Change(format, "120", L"120", 3);
          } else
            // YYYYMMDD
            if (format->Compare("'YYYYMMDD'", L"'YYYYMMDD'", 10) == true) {
              Token::Change(name, "CONVERT(VARCHAR(8), ",
                            L"CONVERT(VARCHAR(8), ", 20);
              Token::Remove(open);
              Token::Change(format, "112", L"112", 3);
            } else
              // YYYY/MM/DD
              if (format->Compare("'YYYY/MM/DD'", L"'YYYY/MM/DD'", 12) ==
                  true) {
                Token::Change(name, "CONVERT(VARCHAR(10), ",
                              L"CONVERT(VARCHAR(10), ", 21);
                Token::Remove(open);
...
bool SqlParser::ParseFunctionDatename(Token *name, Token *open) {
  ...
  if (_target == SQL_ORACLE) {
    ...
    else if (TOKEN_CMP(datepart, "qq") || TOKEN_CMP(datepart, "quarter"))
      TOKEN_CHANGE(name, "QUARTER");
    else if (TOKEN_CMP(datepart, "mm") || TOKEN_CMP(datepart, "month"))
      TOKEN_CHANGE(name, "MONTHNAME");
    else if (TOKEN_CMP(datepart, "wk") || TOKEN_CMP(datepart, "week"))
      TOKEN_CHANGE(name, "WEEK");
    else if (TOKEN_CMP(datepart, "dd") || TOKEN_CMP(datepart, "day"))
      TOKEN_CHANGE(name, "DAY");
    else if (TOKEN_CMP(datepart, "dy") || TOKEN_CMP(datepart, "dayofyear"))
      TOKEN_CHANGE(name, "DAYOFYEAR");
    else if (TOKEN_CMP(datepart, "dw") || TOKEN_CMP(datepart, "weekday"))
      TOKEN_CHANGE(name, "DAYNAME");
    else if (TOKEN_CMP(datepart, "hh") || TOKEN_CMP(datepart, "hour"))
      TOKEN_CHANGE(name, "HOUR");
    else if (TOKEN_CMP(datepart, "mi") || TOKEN_CMP(datepart, "minute"))
      TOKEN_CHANGE(name, "MINUTE");
    else if (TOKEN_CMP(datepart, "ss") || TOKEN_CMP(datepart, "second"))
      TOKEN_CHANGE(name, "SECOND");
    else if (TOKEN_CMP(datepart, "ms") || TOKEN_CMP(datepart, "millisecond")) {
      TOKEN_CHANGE(name, "MICROSECOND");
      PREPEND(name, "CAST(");
      APPEND_FMT(close, "/1000 AS INT)", name);
    } else if (TOKEN_CMP(datepart, "us") || TOKEN_CMP(datepart, "microsecond"))
      TOKEN_CHANGE(name, "MICROSECOND");
  }
...
bool SqlParser::ParseFunctionDatetimeInformix(Token *name, Token *open) {
  ...
  if (Token::Compare(field1, "YEAR", L"YEAR", 4) == true &&
    ...
    // TIMESTAMP 'literal' allow missing fraction, or specify any number of
    // digits in fraction, seconds must be specified
    if (_target == SQL_ORACLE) {
  ...
  if (_target == SQL_ORACLE) {
    ...
    if (locale != NULL) {
      if (Token::Compare(locale, "'CLDR181_en_US'", L"'CLDR181_en_US'", 15))
        Token::Change(locale, "'NLS_DATE_LANGUAGE = AMERICAN'",
                      L"'NLS_DATE_LANGUAGE = AMERICAN'", 30);
      else if (Token::Compare(locale, "'CLDR181_de_DE'", L"'CLDR181_de_DE'",
                              15))
        Token::Change(locale, "'NLS_DATE_LANGUAGE = GERMAN'",
                      L"'NLS_DATE_LANGUAGE = GERMAN'", 28);
      else if (Token::Compare(locale, "'CLDR181_fr_FR'", L"'CLDR181_fr_FR'",
                              15))
        Token::Change(locale, "'NLS_DATE_LANGUAGE = FRENCH'",
                      L"'NLS_DATE_LANGUAGE = FRENCH'", 28);
    }
  } else
...
bool SqlParser::ParseFunctionDayofweekIso(Token *name, Token *open) {
  ...
  if (_target == SQL_ORACLE) {
    ...
    // Note. SET DATEFIRST 1 must be executed in SQL Server as the start day is
    // Sunday by default in US (1 in Europe i.e.), while ISO requires Monday SET
    // DATEFIRST 1 is not allowed inside CREATE FUNCTION(!)
    TOKEN_CHANGE(name, "DATEPART");
...
bool SqlParser::ParseFunctionDays(Token *name, Token *open) {
  ...
  if (_target == SQL_SQL_SERVER) {
    ...
    if (second != NULL) {
      // An integer constant means to add the specified number of days in Sybase
      // ASA
    ...
    else if (_source == SQL_SYBASE_ASA)
...
bool SqlParser::ParseFunctionDbinfo(Token *name, Token *open) {
  ...
  // "sqlca.sqlerrd1" or 'sqlca.sqlerrd1' mean the last SERIAL value (see also
  // LET var = DBINFO conversion pattern)
  if (exp->Compare("\"sqlca.sqlerrd1\"", L"\"sqlca.sqlerrd1\"", 16) == true ||
    ...
    // "sqlca.sqlerrd2" or 'sqlca.sqlerrd2' mean the number of affected rows by
...
bool SqlParser::ParseFunctionDbInstanceid(Token *name, Token *open) {
  ...
  if (_target == SQL_ORACLE) {
    if (exp == NULL) {
      Token::Change(name, "SYS_CONTEXT('USERENV', 'INSTANCE'",
                    L"SYS_CONTEXT('USERENV', 'INSTANCE'", 33);
      Token::Remove(open);
    }
  } else
...
bool SqlParser::ParseFunctionDigits(Token *name, Token * /*open*/) {
  ...
  // Convert to TRANSLATE in Oracle, if 3rd parameter is '' then everything
  // removed
  if (_target == SQL_ORACLE) {
...
bool SqlParser::ParseFunctionExtract(Token *name, Token * /*open*/) {
  ...
  } else if (Token::Compare(unit, "MONTH", L"MONTH", 5) == true) {
  ...
  } else if (Token::Compare(unit, "DAY", L"DAY", 3) == true) {
  ...
  } else if (Token::Compare(unit, "HOUR", L"HOUR", 4) == true) {
  ...
  } else if (Token::Compare(unit, "MINUTE", L"MINUTE", 6) == true) {
  ...
  } else if (Token::Compare(unit, "SECOND", L"SECOND", 6) == true) {
...
bool SqlParser::ParseFunctionGetutcdate(Token *name, Token *open) {
  ...
  if (_target == SQL_ORACLE) {
    Token::Change(name, "SYS_EXTRACT_UTC(SYSTIMESTAMP",
                  L"SYS_EXTRACT_UTC(SYSTIMESTAMP", 28);
    Token::Remove(open);
  } else
...
bool SqlParser::ParseFunctionHash(Token *name, Token *open) {
  ...
  if (_target == SQL_SQL_SERVER) {
    ...
    if (_target == SQL_ORACLE) {
      Token::Change(name, "DBMS_CRYPTO.HASH(UTL_RAW.CAST_TO_RAW",
                    L"DBMS_CRYPTO.HASH(UTL_RAW.CAST_TO_RAW", 36);
      Append(string, ")", L")", 1);
      ...
      if (algorithm != NULL) {
        ...
        else if (Token::Compare(algorithm, "'SHA1'", L"'SHA1'", 6) == true)
      ...
      if (algorithm == NULL || TOKEN_CMP(algorithm, "'MD5'")) {
        ...
        Token::Remove(comma, algorithm);
      } else if (TOKEN_CMP(algorithm, "'SHA1'")) {
...
bool SqlParser::ParseFunctionHextoint(Token *name, Token *open) {
  ...
  // Convert to CONVERT in SQL Server
  if (_target == SQL_SQL_SERVER) {
    Token::Change(name, "CONVERT(INT, CONVERT(VARBINARY(8), ",
                  L"CONVERT(INT, CONVERT(VARBINARY(8), ", 35);
    Token::Remove(open);
    Prepend(close, ", 1)", L", 1)", 4);
  } else
    // Convert to TO_NUMBER in Oracle
...
bool SqlParser::ParseFunctionIdentity(Token *name, Token *open) {
  ...
  if (_target == SQL_ORACLE) {
    ...
    if (_target == SQL_SQL_SERVER) {
      ...
      Token::Remove(exp);
      Append(close, " OVER(ORDER BY (SELECT 1))", L" OVER(ORDER BY (SELECT 1))",
             26, name);
    }
...
bool SqlParser::ParseFunctionIfnull(Token *name, Token *open) {
  ...
  // Third expression is optional in Sybase ASA; only 2 expressions allowed in
  // MySQL and Sybase ADS
  if (comma2 != NULL) {
    exp3 = GetNextToken();
  ...
  if (_target == SQL_ORACLE) {
    if (_source == SQL_MYSQL)
      ...
      // If 3 parameters are specified, the order of 2nd and 3rd parameters is
      // different in NVL2
      if (exp3 != NULL) {
      ...
      // If 2 parameters specified, second must be NULL in NVL2 (see Sybase
      // IFNULL docs)
      else
...
bool SqlParser::ParseFunctionInttohex(Token *name, Token *open) {
  ...
  if (_target == SQL_ORACLE) {
    ...
    // Convert to CONVERT in SQL Server
    if (_target == SQL_SQL_SERVER) {
      Token::Change(name, "CONVERT(VARBINARY(8), ", L"CONVERT(VARBINARY(8), ",
                    22);
      Token::Remove(open);
    } else if (Target(SQL_MYSQL, SQL_MARIADB)) {
      TOKEN_CHANGE(name, "LPAD(HEX");
...
bool SqlParser::ParseFunctionList(Token *name, Token *open) {
  ...
  Token *distinct =
      (all == NULL) ? GetNextWordToken("DISTINCT", L"DISTINCT", 8) : NULL;
  ...
  // STUFF and FOR XML XPATH in SQL Server (this is only the first part of
  // conversion; it will be completed in the end of SELECT
  if (_target == SQL_SQL_SERVER) {
    ...
    // If delimiter is specified append it before expression, otherwise use
    // default ',' delimiter
    if (del != NULL) {
...
bool SqlParser::ParseFunctionLocate(Token *name, Token *open) {
  ...
  if (comma2 != NULL) {
    ...
    // For DB2, if start paramter points to string unit this means start
  ...
  if (_target == SQL_ORACLE) {
    ...
    if (_target == SQL_SQL_SERVER) {
      ...
      // In SQL Server change the order of search and source parameters for
      // Sybase ASA LOCATE
...
bool SqlParser::ParseFunctionMdy(Token *name, Token *open) {
  ...
  if (_target == SQL_ORACLE) {
    // All parts are specified as integer constants, use DATE '2013-09-27'
    // syntax
    if (month->IsNumeric() == true && day->IsNumeric() == true &&
        year->IsNumeric() == true) {
      Token::Change(name, "DATE", L"DATE", 4);
    ...
    // TO_DATE(TO_CHAR(month, 'FM09') || TO_CHAR(day, 'FM09') || TO_CHAR(year,
    // 'FM0009'), 'MMDDYYYY') in Oracle
    else {
      Token::Change(name, "TO_DATE", L"TO_DATE", 7);
      Token::Change(comma, " ", L" ", 1);
      Token::Change(comma2, " ", L" ", 1);
...
bool SqlParser::ParseFunctionOverlay(Token *name, Token * /*open*/) {
  ...
  // If FOR syntax is used it is optional and while skipped still can be
  // followed by not optional USING
  if (Token::Compare(del3, "FOR", L"FOR", 3) ||
      Token::Compare(del3, ",", L",", 1)) {
    Token *length = GetNextToken();
...
bool SqlParser::ParseFunctionRaiseError(Token *name, Token * /*open*/) {
  ...
  if (_target == SQL_ORACLE)
    Token::Change(name, "RAISE_APPLICATION_ERROR", L"RAISE_APPLICATION_ERROR",
                  23);
...
bool SqlParser::ParseFunctionRaiserror(Token *name, Token *open) {
  ...
  if (Target(SQL_MARIADB, SQL_MYSQL)) {
    ...
    Token::Change(open, " SQLSTATE '02000' SET MESSAGE_TEXT = ",
                  L" SQLSTATE '02000' SET MESSAGE_TEXT = ", 37);
...
bool SqlParser::ParseFunctionSecond(Token *name, Token *open) {
  ...
  // Convert to EXTRACT in Oracle
  if (_target == SQL_ORACLE) {
    Token::Change(name, "TRUNC(EXTRACT(SECOND FROM ",
                  L"TRUNC(EXTRACT(SECOND FROM ", 26);
    Token::Remove(open);
    Append(close, ")", L")", 1);
...
bool SqlParser::ParseFunctionStrip(Token *name, Token *open) {
  ...
  if (_target == SQL_ORACLE) {
    ...
    if (type != NULL) {
      ...
      else if (Token::Compare(type, "L", L"L", 1))
        Append(open, "LEADING", L"LEADING", 7, type);
      else if (Token::Compare(type, "T", L"T", 1))
...
bool SqlParser::ParseFunctionSubstring(Token *name, Token * /*open*/) {
  ...
  // FROM can be used instead of comma before start position in DB2; Informix
  // requires FROM
  ...
  // Length is optional, FOR can be used instead of comma in DB2; Informix
  // requires FOR
...
bool SqlParser::ParseFunctionSuserName(Token *name, Token *open) {
  ...
  if (_target == SQL_ORACLE) {
    if (exp == NULL) {
      Token::Change(name, "SYS_CONTEXT('USERENV', 'OS_USER'",
                    L"SYS_CONTEXT('USERENV', 'OS_USER'", 32);
      Token::Remove(open);
    }
  } else if (Target(SQL_MARIADB, SQL_MYSQL))
...
bool SqlParser::ParseFunctionTimestampadd(Token *name, Token * /*open*/) {
  ...
  if (Target(SQL_SQL_SERVER)) {
    ...
    else if (TOKEN_CMP(unit, "SQL_TSI_QUARTER"))
      TOKEN_CHANGE_NOFMT(unit, "qq");
    else if (TOKEN_CMP(unit, "SQL_TSI_MONTH"))
      TOKEN_CHANGE_NOFMT(unit, "mm");
    else if (TOKEN_CMP(unit, "SQL_TSI_WEEK"))
      TOKEN_CHANGE_NOFMT(unit, "wk");
    else if (TOKEN_CMP(unit, "SQL_TSI_DAY"))
      TOKEN_CHANGE_NOFMT(unit, "dd");
    else if (TOKEN_CMP(unit, "SQL_TSI_HOUR"))
      TOKEN_CHANGE_NOFMT(unit, "hh");
    else if (TOKEN_CMP(unit, "SQL_TSI_MINUTE"))
      TOKEN_CHANGE_NOFMT(unit, "mi");
    else if (TOKEN_CMP(unit, "SQL_TSI_SECOND"))
      TOKEN_CHANGE_NOFMT(unit, "ss");
    else if (TOKEN_CMP(unit, "SQL_TSI_FRAC_SECOND"))
      TOKEN_CHANGE_NOFMT(unit, "ss");
  }
        ...
        if (format->Compare("'9,999,999'", L"'9,999,999'", 11) == true) {
          ...
          if (_target == SQL_SQL_SERVER) {
            ...
            if (format->Compare("'YYYY-MM-DD'", L"'YYYY-MM-DD'", 12) == true) {
              ...
              if (format->Compare("'YYYYMMDD'", L"'YYYYMMDD'", 10) == true) {
                ...
                if (format->Compare("'YYYY/MM/DD'", L"'YYYY/MM/DD'", 12) ==
                  ...
                  // HH24:MI:SS
                  if (format->Compare("'HH24:MI:SS'", L"'HH24:MI:SS'", 12) ==
                      true) {
                    Token::Change(name, "CONVERT(VARCHAR(8), ",
                                  L"CONVERT(VARCHAR(8), ", 20);
                    Token::Remove(open);
            ...
            if (Target(SQL_MYSQL) == true) {
              ...
              if (_source == SQL_INFORMIX &&
                  Target(SQL_ORACLE, SQL_DB2) == true) {
                TokenStr out;
                size_t i = 0;
                  ...
                  if (Token::CompareCS(format, "%Y", L"%Y", i, 2) == true) {
                    ...
                    if (Token::CompareCS(format, "%y", L"%y", i, 2) == true) {
                      ...
                      if (Token::CompareCS(format, "%m", L"%m", i, 2) == true) {
                        ...
                        // %d day (01-31)
                        if (Token::CompareCS(format, "%d", L"%d", i, 2) ==
                            true) {
                          if (Target(SQL_ORACLE, SQL_DB2) == true)
                            out.Append("DD", L"DD", 2);
...
bool SqlParser::ParseFunctionToTimestampTz(Token *name, Token * /*open*/) {
  ...
  STATS_SET_COMPLEXITY(Target(SQL_MYSQL, SQL_MARIADB, SQL_MARIADB_ORA),
                       STATS_CONV_MEDIUM)
...
bool SqlParser::ParseFunctionTrim(Token *name, Token * /*open*/) {
  ...
  if (_target == SQL_SQL_SERVER) {
    ...
    if (_target == SQL_ORACLE) {
      ...
      else if (Token::Compare(type, "B", L"B", 1))
...
bool SqlParser::ParseFunctionTrunc(Token *name, Token *open) {
  ...
  if (unit == NULL && exp->data_type == TOKEN_DT_DATETIME) {
    if (_target == SQL_SQL_SERVER) {
      Token::Change(name, "CONVERT(DATETIME, CONVERT(DATE, ",
                    L"CONVERT(DATETIME, CONVERT(DATE, ", 31);
      Token::Remove(open);
      Append(close, ")", L")", 1);
...
bool SqlParser::ParseFunctionUser(Token *name) {
  ...
  STATS_DECL
  // Convert to SYSTEM_USER in SQL Server (CURRENT_USER is also supported but
  // returns 'dbo' i.e.)
  if (_target == SQL_SQL_SERVER)
    Token::Change(name, "SYSTEM_USER", L"SYSTEM_USER", 11);
  else
...
bool SqlParser::ParseFunctionXmlrow(Token *name, Token * /*open*/) {
  ...
  if (option != NULL) {
    ...
    if (as != NULL)
      /*Token *attributes */ (void)GetNextWordToken("ATTRIBUTES", L"ATTRIBUTES",
                                                    10);
    else
...
bool SqlParser::ParseFunctionXmlvalidate(Token *name, Token * /*open*/) {
  ...
  if (according != NULL) {
    ...
    if (id != NULL)
      ...
      /*Token *namespace_ */ (void)GetNextWordToken("NAMESPACE", L"NAMESPACE",
                                                    9);
      /*Token *uri2 */ (void)GetNextToken();
    }
    ...
    if (namespace2 != NULL)
      ...
      /*Token *namespace3 */ (void)GetNextWordToken("NAMESPACE", L"NAMESPACE",
                                                    9);
