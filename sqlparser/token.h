...
public:
  ...
  bool Compare(const char *word, const wchar_t *w_word, size_t start,
               size_t len);
  bool Compare(const char ch, const wchar_t wch);
  bool Compare(const char ch, const wchar_t wch, size_t start);

  static bool Compare(Token *token, const char *word, const wchar_t *w_word,
                      size_t len);
  static bool Compare(Token *token, const char *word, const wchar_t *w_word,
                      size_t start, size_t len);
  static bool CompareCS(Token *token, const char *word, const wchar_t *w_word,
                        size_t start, size_t len);
  ...
  static bool CompareTarget(Token *token, const char *word,
...
public:
  ...
  TokenStr(const char *s, const wchar_t *w, size_t l) {
    Set(s, w, l);
    prev = NULL;
    next = NULL;
  }
  ...
  static bool Compare(TokenStr *tokenstr, const char *word,
                      const wchar_t *w_word, size_t len);
  static bool Compare(TokenStr *tokenstr, const char ch, const wchar_t wch,
                      size_t pos);
