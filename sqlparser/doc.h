...
#define MEDIA_WARN_SIGN_HTML                                                   \
  "&nbsp;<img src=\"http://www.sqlines.com/_media/exclamation.png\">"
#define MEDIA_OK_SIGN_HTML                                                     \
  "&nbsp;<img src=\"http://www.sqlines.com/_media/green_tick.gif\" "           \
  "width=\"11\" height=\"11\">"
#define MEDIA_ERROR_SIGN_HTML                                                  \
  "&nbsp;<img src=\"http://www.sqlines.com/_media/red_cross.png\" "            \
  "width=\"11\" height=\"11\">"
...
#define SQL_PROC_PRAGMA_EXCEPTION_INIT_DESC                                    \
  "Associate exception with error number"
#define SQL_PROC_PRAGMA_RESTRICT_REFERENCES_DESC                               \
  "Set restrictions for function or procedure"
...
#define PLSQL_STMT_EXCEPTION_ACCESS_INTO_NULL_DESC                             \
  "Assign attribute of NULL object"
#define PLSQL_STMT_EXCEPTION_CASE_NOT_FOUND_DESC "No condition met in CASE"
#define PLSQL_STMT_EXCEPTION_COLLECTION_IS_NULL_DESC                           \
  "Assigning to NULL collection"
...
#define PLSQL_STMT_EXCEPTION_INVALID_NUMBER_DESC                               \
  "String does not represent valid number"
...
#define PLSQL_STMT_EXCEPTION_NO_DATA_NEEDED_DESC                               \
  "Early exit from pipelined function"
...
#define PLSQL_STMT_EXCEPTION_SUBSCRIPT_BEYOND_COUNT_DESC                       \
  "Index number too large"
#define PLSQL_STMT_EXCEPTION_SUBSCRIPT_OUTSIDE_LIMIT_DESC                      \
...
#define PLSQL_STMT_EXCEPTION_TOO_MANY_ROWS_DESC                                \
...
#define SEQUENCE_NOORDER_DESC                                                  \
  "No need to guarantee sequence numbers in order of requests"
#define SEQUENCE_NOORDER_CONV                                                  \
  "Option is not supported, removed as it is default"
...
#define SQL_PKG_DBMS_OUTPUT_PUT_LINE_DESC                                      \
  "Place line in the buffer or print line"
