...
bool SqlParser::ParseSybaseWhileFetchStatement(Token *while_, Token *fetch,
                                               int scope) {
...
// Sybase ADS nested UDF call without variable assinment SELECT udf(params) FROM
// System.iota (standalone SELECT)
void SqlParser::SybaseAdsSelectNestedUdfCall(Token *select,
                                             ListW *select_cols) {
...
void SqlParser::SybaseMapDatetimeStyle(Token *style) {
  ...
  } else if (TOKEN_CMP(style, "1")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%m/%d/%y'");
  } else if (TOKEN_CMP(style, "101")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%m/%d/%Y'");
  } else if (TOKEN_CMP(style, "2")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%y.%m.%d'");
  } else if (TOKEN_CMP(style, "102")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%Y.%m.%d'");
  } else if (TOKEN_CMP(style, "3")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%d/%m/%y'");
  } else if (TOKEN_CMP(style, "103")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%d/%m/%Y'");
  } else if (TOKEN_CMP(style, "4")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%d.%m.%y'");
  } else if (TOKEN_CMP(style, "104")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%d.%m.%Y'");
  } else if (TOKEN_CMP(style, "5")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%d-%m-%y'");
  } else if (TOKEN_CMP(style, "105")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%d-%m-%Y'");
  } else if (TOKEN_CMP(style, "6")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%d %b %y'");
  } else if (TOKEN_CMP(style, "106")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%d %b %Y'");
  } else if (TOKEN_CMP(style, "7")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%b %d, %y'");
  } else if (TOKEN_CMP(style, "107")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%b %d, %Y'");
  } else if (TOKEN_CMP(style, "8") || TOKEN_CMP(style, "108")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%H:%i:%s'");
  } else if (TOKEN_CMP(style, "9") || TOKEN_CMP(style, "109")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%b %d %Y %h:%i:%s:%f%p'");
  } else if (TOKEN_CMP(style, "10")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%m-%d-%y'");
  } else if (TOKEN_CMP(style, "110")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%m-%d-%Y'");
  } else if (TOKEN_CMP(style, "11")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%y/%m/%d'");
  } else if (TOKEN_CMP(style, "111")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%Y/%m/%d'");
  } else if (TOKEN_CMP(style, "12")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%y%m%d'");
  } else if (TOKEN_CMP(style, "112")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%Y%m%d'");
  } else if (TOKEN_CMP(style, "13")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%y/%d/%m'");
  } else if (TOKEN_CMP(style, "113")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%Y/%d/%m'");
  } else if (TOKEN_CMP(style, "14")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%m/%y/%d'");
  } else if (TOKEN_CMP(style, "114")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%m/%Y/%d'");
  } else if (TOKEN_CMP(style, "15")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%d/%y/%m'");
  } else if (TOKEN_CMP(style, "115")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%d/%Y/%m'");
  } else if (TOKEN_CMP(style, "16") || TOKEN_CMP(style, "116")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%b %d %Y %H:%i:%s'");
  } else if (TOKEN_CMP(style, "17") || TOKEN_CMP(style, "117")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%h:%i%p'");
  } else if (TOKEN_CMP(style, "18") || TOKEN_CMP(style, "118")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%H:%i'");
  } else if (TOKEN_CMP(style, "19")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%h:%i:%s:%f%p'");
  } else if (TOKEN_CMP(style, "20")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%H:%i:%s:%f'");
  } else if (TOKEN_CMP(style, "21")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%y/%m/%d %H:%i:%s'");
  } else if (TOKEN_CMP(style, "22")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%y/%m/%d %h:%i%p'");
  } else if (TOKEN_CMP(style, "23")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%Y-%m-%dT%H:%i:%s'");
  } else if (TOKEN_CMP(style, "36") || TOKEN_CMP(style, "136")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%h:%i:%s.%f%p'");
  } else if (TOKEN_CMP(style, "37") || TOKEN_CMP(style, "137")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%H:%i:%s.%f'");
  } else if (TOKEN_CMP(style, "38")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%b %d %y %h:%i:%s.%f%p'");
  } else if (TOKEN_CMP(style, "138")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%b %d %Y %h:%i:%s.%f%p'");
  } else if (TOKEN_CMP(style, "39")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%b %d %y %H:%i:%s.%f'");
  } else if (TOKEN_CMP(style, "139")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%b %d %Y %H:%i:%s.%f'");
  } else if (TOKEN_CMP(style, "40")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%y-%m-%d %H:%i:%s.%f'");
  } else if (TOKEN_CMP(style, "140")) {
    if (Target(SQL_MARIADB, SQL_MYSQL))
      TOKEN_CHANGE_NOFMT(style, "'%Y-%m-%d %H:%i:%s.%f'");
  }
}