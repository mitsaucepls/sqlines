...
typedef SQLRETURN(SQL_API *SQLBindParameterFunc)(
    SQLHSTMT hstmt, SQLUSMALLINT ipar, SQLSMALLINT fParamType,
    SQLSMALLINT fCType, SQLSMALLINT fSqlType, SQLULEN cbColDef,
    SQLSMALLINT ibScale, SQLPOINTER rgbValue, SQLLEN cbValueMax,
    SQLLEN *pcbValue);
typedef SQLRETURN(SQL_API *SQLConnectFunc)(
...
typedef SQLRETURN(SQL_API *SQLEndTranFunc)(SQLSMALLINT HandleType,
                                           SQLHANDLE Handle,
...
typedef SQLRETURN(SQL_API *SQLPrepareFunc)(SQLHSTMT StatementHandle,
                                           SQLCHAR *StatementText,
                                           SQLINTEGER TextLength);
