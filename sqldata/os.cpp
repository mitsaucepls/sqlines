...
#if defined(WIN32) || defined(_WIN64)
HMODULE Os::LoadLibrary(const char *name) { return ::LoadLibrary(name); }
#else
void *Os::LoadLibrary(const char *name) { return dlopen(name, RTLD_NOW); }
#endif
...
#elif defined(_WIN64)
bool Os::Is64Bit(const char * /*filename*/) { return false; }
#endif

// Get current time in milliseconds
size_t Os::GetTickCount() { return ::GetTickCount(); }
...
const char *Os::CurrentTimestamp() {
  ...
  SYSTEMTIME lt;
  GetLocalTime(&lt);
  sprintf(ts, "%d-%02d-%02d %02d:%02d:%02d.%03d", lt.wYear, lt.wMonth, lt.wDay,
