...
// BCP functions require ODBC Manager handles to use, not SQL Server Native
// Client handles Underlying SQL Server Native Client functions can be
// successfully used to query and retrieve data except BCP extension
...
// ODBC API Functions
typedef SQLRETURN(SQL_API *SQLAllocHandleFunc)(SQLSMALLINT HandleType,
                                               SQLHANDLE InputHandle,
                                               SQLHANDLE *OutputHandle);
typedef SQLRETURN(SQL_API *SQLBindColFunc)(
...
typedef SQLRETURN(SQL_API *SQLDescribeColFunc)(
...
typedef SQLRETURN(SQL_API *SQLDriverConnectFunc)(
    SQLHDBC hdbc, SQLHWND hwnd, SQLCHAR *szConnStrIn, SQLSMALLINT cchConnStrIn,
    SQLCHAR *szConnStrOut, SQLSMALLINT cchConnStrOutMax,
    SQLSMALLINT *pcchConnStrOut, SQLUSMALLINT fDriverCompletion);
typedef SQLRETURN(SQL_API *SQLExecDirectFunc)(SQLHSTMT StatementHandle,
                                              SQLCHAR *StatementText,
                                              SQLINTEGER TextLength);
typedef SQLRETURN(SQL_API *SQLFetchFunc)(SQLHSTMT StatementHandle);
typedef SQLRETURN(SQL_API *SQLFreeHandleFunc)(SQLSMALLINT HandleType,
                                              SQLHANDLE Handle);
typedef SQLRETURN(SQL_API *SQLGetDataFunc)(SQLHSTMT StatementHandle,
                                           SQLUSMALLINT Col_or_Param_Num,
                                           SQLSMALLINT TargetType,
                                           SQLPOINTER TargetValuePtr,
                                           SQLLEN BufferLength,
                                           SQLLEN *StrLen_or_IndPtr);
typedef SQLRETURN(SQL_API *SQLGetDiagRecFunc)(
...
typedef SQLRETURN(SQL_API *SQLNumResultColsFunc)(SQLHSTMT StatementHandle,
                                                 SQLSMALLINT *ColumnCount);
typedef SQLRETURN(SQL_API *SQLSetConnectAttrFunc)(SQLHDBC ConnectionHandle,
                                                  SQLINTEGER Attribute,
                                                  SQLPOINTER ValuePtr,
                                                  SQLINTEGER StringLength);
typedef SQLRETURN(SQL_API *SQLSetEnvAttrFunc)(SQLHENV EnvironmentHandle,
                                              SQLINTEGER Attribute,
                                              SQLPOINTER Value,
                                              SQLINTEGER StringLength);
typedef SQLRETURN(SQL_API *SQLSetStmtAttrFunc)(SQLHSTMT StatementHandle,
                                               SQLINTEGER Attribute,
                                               SQLPOINTER Value,
                                               SQLINTEGER StringLength);
...
typedef RETCODE(SQL_API *bcp_bindFunc)(HDBC, LPCBYTE, INT, DBINT, LPCBYTE, INT,
                                       INT, INT);
typedef RETCODE(SQL_API *bcp_controlFunc)(HDBC, INT, void *);
typedef DBINT(SQL_API *bcp_doneFunc)(HDBC);
typedef RETCODE(SQL_API *bcp_initFunc)(HDBC, const char *, const char *,
                                       const char *, INT);
...
public:
  ...
  bool IsQuoteRequired(std::string &name) {
    return IsQuoteRequired(name.c_str());
  }
