...
int SqlStdApi::Connect(size_t * /*time_spent*/) { return 0; }

// Get row count for the specified object
int SqlStdApi::GetRowCount(const char * /*object*/, int * /*count*/,
                           size_t * /*time_spent*/) {
  return -1;
}

// Execute the statement and get scalar result
int SqlStdApi::ExecuteScalar(const char * /*query*/, int * /*result*/,
                             size_t * /*time_spent*/) {
  return -1;
}

// Execute the statement
int SqlStdApi::ExecuteNonQuery(const char * /*query*/,
                               size_t * /*time_spent*/) {
  return -1;
}

// Open cursor and allocate buffers
int SqlStdApi::OpenCursor(const char * /*query*/, size_t /*buffer_rows*/,
                          int /*buffer_memory*/, size_t * /*col_count*/,
                          size_t * /*allocated_array_rows*/,
                          int * /*rows_fetched*/, SqlCol ** /*cols*/,
                          size_t * /*time_spent*/, bool /*catalog_query*/,
...
int SqlStdApi::CloseCursor() { return -1; }

// Initialize the bulk copy from one database into another
int SqlStdApi::InitBulkTransfer(const char * /*table*/, size_t col_count,
                                size_t allocated_array_rows,
...
int SqlStdApi::TransferRows(SqlCol *s_cols, int rows_fetched, int *rows_written,
      ...
      if (_source_api_type == SQLDATA_DB2 ||
        ...
        if (_source_api_type ==
          ...
          ind = (size_t)((int *)(s_cols[k].ind))[i];
                 ...
                 s_cols[k]._ind2 != NULL && s_cols[k]._ind2[i] != -1)
        ind = (size_t)s_cols[k]._len_ind2[i];
      else if (_source_api_type == SQLDATA_SYBASE && s_cols[k]._ind2 != NULL &&
               s_cols[k]._ind2[i] != -1)
...
int SqlStdApi::CloseBulkTransfer() { return 0; }

// Specifies whether API allows to parallel reading from this API and write to
// another API
bool SqlStdApi::CanParallelReadWrite() { return true; }

// Drop the table
int SqlStdApi::DropTable(const char * /*table*/, size_t * /*time_spent*/,
...
int SqlStdApi::GetLobLength(size_t /*row*/, size_t /*column*/,
                            size_t * /*length*/) {
  return -1;
}

// Get LOB content
int SqlStdApi::GetLobContent(size_t /*row*/, size_t /*column*/, void * /*data*/,
                             size_t /*length*/, int * /*len_ind*/) {
  return -1;
}

// Get partial LOB content
int SqlStdApi::GetLobPart(size_t /*row*/, size_t /*column*/, void * /*data*/,
                          size_t /*length*/, int * /*len_ind*/) {
  return -1;
}

// Get the list of available tables
int SqlStdApi::GetAvailableTables(std::string & /*table_template*/,
                                  std::string & /*exclude*/,
...
int SqlStdApi::ReadSchema(const char * /*select*/, const char * /*exclude*/,
                          bool /*read_cns*/, bool /*read_idx*/) {
  return -1;
}

// Get table name by constraint name
int SqlStdApi::ReadConstraintTable(const char * /*schema*/,
...
int SqlStdApi::ReadConstraintColumns(const char * /*schema*/,
                                     const char * /*table*/,
                                     const char * /*constraint*/,
                                     std::string & /*cols*/) {
  return -1;
...
void SqlStdApi::GetCatalogSelectionCriteria(
