...
#define OCI_64BIT_DLL_LOAD_ERROR                                               \
  "Loading Oracle OCI oci.dll: 64-bit library loaded, use 32-bit Oracle "      \
  "client or 64-bit version of SQLines Data"
#else
...
typedef sword (*OCIArrayDescriptorAllocFunc)(void *, void **, ub4, ub4, size_t,
                                             void **);
typedef sword (*OCIAttrGetFunc)(void *, ub4, void *, ub4 *, ub4, OCIError *);
typedef sword (*OCIAttrSetFunc)(void *, ub4, void *, ub4, ub4, OCIError *);
typedef sword (*OCIBindByPosFunc)(OCIStmt *stmtp, OCIBind **bindpp,
                                  OCIError *errhp, ub4 position, dvoid *valuep,
                                  sb4 value_sz, ub2 dty, dvoid *indp,
                                  ub2 *alenp, ub2 *rcodep, ub4 maxarr_len,
                                  ub4 *curelep, ub4 mode);
typedef sword (*OCIDefineByPosFunc)(OCIStmt *, OCIDefine **, OCIError *, ub4,
                                    dvoid *, sb4, ub2, dvoid *, ub2 *, ub2 *,
                                    ub4);
typedef sword (*OCIDescriptorAllocFunc)(void *, void **, ub4, size_t, void **);
typedef sword (*OCIDescriptorFreeFunc)(void *, ub4);
typedef sword (*OCIEnvCreateFunc)(
...
typedef sword (*OCILobCharSetFormFunc)(OCIEnv *envhp, OCIError *errhp,
                                       CONST OCILobLocator *locp, ub1 *csfrm);
typedef sword (*OCILobCopyFunc)(OCISvcCtx *, OCIError *, OCILobLocator *dst,
                                OCILobLocator *src, ub4 amount, ub4 dst_ffset,
                                ub4 src_offset);
typedef sword (*OCILobCreateTemporaryFunc)(OCISvcCtx *, OCIError *,
                                           OCILobLocator *, ub2 csid, ub1 csfrm,
                                           ub1 lobtype, boolean cache,
                                           OCIDuration);
typedef sword (*OCILobFreeTemporaryFunc)(OCISvcCtx *, OCIError *,
                                         OCILobLocator *);
typedef sword (*OCILobGetLength2Func)(OCISvcCtx *, OCIError *, OCILobLocator *,
                                      oraub8 *);
typedef sword (*OCILobRead2Func)(OCISvcCtx *, OCIError *, OCILobLocator *,
                                 oraub8 *, oraub8 *, oraub8, void *, oraub8,
                                 ub1, void *,
                                 OCICallbackLobRead2(cbfp)(void *, const void *,
                                                           oraub8, ub1, void **,
                                                           oraub8 *),
                                 ub2, ub1);
typedef sword (*OCILobTrimFunc)(OCISvcCtx *, OCIError *, OCILobLocator *,
                                ub4 newlen);
typedef sword (*OCILobWriteFunc)(OCISvcCtx *, OCIError *, OCILobLocator *,
                                 ub4 *amtp, ub4 offset, dvoid *bufp, ub4 buflen,
                                 ub1 piece, dvoid *ctxp,
                                 OCICallbackLobWrite(cbfp)(dvoid *, dvoid *,
                                                           ub4 *, ub1 *),
                                 ub2 csid, ub1 csfrm);
typedef sword (*OCILobWriteAppendFunc)(
    OCISvcCtx *, OCIError *, OCILobLocator *locp, ub4 *amtp, dvoid *bufp,
    ub4 buflen, ub1 piece, dvoid *ctxp,
    OCICallbackLobWrite(cbfp)(dvoid *, dvoid *, ub4 *, ub1 *), ub2 csid,
    ub1 csfrm);
typedef sword (*OCIParamGetFunc)(const void *hndlp, ub4, OCIError *, void **,
                                 ub4);
typedef sword (*OCIServerAttachFunc)(OCIServer *, OCIError *, const OraText *,
                                     sb4, ub4);
typedef sword (*OCIServerDetachFunc)(OCIServer *srvhp, OCIError *errhp,
                                     ub4 mode);
typedef sword (*OCISessionBeginFunc)(OCISvcCtx *, OCIError *, OCISession *, ub4,
                                     ub4);
typedef sword (*OCISessionEndFunc)(OCISvcCtx *svchp, OCIError *errhp,
                                   OCISession *usrhp, ub4 mode);
typedef sword (*OCIStmtExecuteFunc)(OCISvcCtx *, OCIStmt *, OCIError *, ub4,
                                    ub4, CONST OCISnapshot *, OCISnapshot *,
                                    ub4);
typedef sword (*OCIStmtFetch2Func)(OCIStmt *, OCIError *, ub4, ub2, sb4, ub4);
typedef sword (*OCIStmtPrepareFunc)(OCIStmt *, OCIError *, CONST text *, ub4,
                                    ub4, ub4);
typedef sword (*OCITransCommitFunc)(OCISvcCtx *svchp, OCIError *errhp,
                                    ub4 flags);
...
class SqlOciApi : public SqlApiBase {
  ...
  // Whether to bind LONG in place without using locators (used in metadata read
  // of short LONG columns)
...
public:
  ...
  // OCI bounds the source buffers, so the same buffers must be passed to
  // TransferRows
  ...
  char *GetLobBuffer(size_t row, size_t column, size_t length,
                     size_t *alloc_len);
  ...
  virtual int GetLobPart(size_t /*row*/, size_t /*column*/, void * /*data*/,
                         size_t /*length*/, int * /*len_ind*/) {
    return -1;
  }

  // Get the list of available tables
  virtual int GetAvailableTables(std::string &select, std::string &exclude,
                                 std::list<std::string> &tables);

  // Read schema information
  virtual int ReadSchema(const char *select, const char *exclude,
                         bool read_cns = true, bool read_idx = true);
  ...
  virtual int ReadConstraintColumns(const char *schema, const char *table,
                                    const char *constraint, std::string &cols);
  ...
  virtual int GetIndexColumns(SqlIndexes &idx, std::list<std::string> &idx_cols,
...
public:
  ...
  // Metadata queries
  static void GetAllTablesQuery(std::string &table_template, std::string &query,
