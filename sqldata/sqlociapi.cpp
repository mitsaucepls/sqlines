...
int SqlOciApi::Init() {
  ...
  const char *oci_lib_param =
      (_parameters != NULL) ? _parameters->Get("-oci_lib") : NULL;
  ...
  if (nls_lang != NULL)
    ...
    if (_target_api_provider != NULL &&
        _target_api_provider->IsTargetUtf8LoadSupported())
  ...
  if (_oci_dll == NULL) {
    ...
    // Try to find Oracle installation paths if the library is not set
    // explicitly
    if (oci_lib_param == NULL)
      FindOraclePaths();

    for (std::list<std::string>::iterator i = _driver_paths.begin();
         i != _driver_paths.end(); i++) {
      std::string loc = (*i);
      loc += OCI_DLL;

      // Try to open DLL
      _oci_dll =
          LoadLibraryEx(loc.c_str(), NULL, LOAD_WITH_ALTERED_SEARCH_PATH);
  ...
  _ociArrayDescriptorAlloc = (OCIArrayDescriptorAllocFunc)Os::GetProcAddress(
      _oci_dll, "OCIArrayDescriptorAlloc");
  ...
  _ociBindByPos =
      (OCIBindByPosFunc)Os::GetProcAddress(_oci_dll, "OCIBindByPos");
  _ociDescriptorAlloc = (OCIDescriptorAllocFunc)Os::GetProcAddress(
      _oci_dll, "OCIDescriptorAlloc");
  _ociDescriptorFree =
      (OCIDescriptorFreeFunc)Os::GetProcAddress(_oci_dll, "OCIDescriptorFree");
  _ociDefineByPos =
      (OCIDefineByPosFunc)Os::GetProcAddress(_oci_dll, "OCIDefineByPos");
  _ociEnvCreate =
      (OCIEnvCreateFunc)Os::GetProcAddress(_oci_dll, "OCIEnvCreate");
  _ociErrorGet = (OCIErrorGetFunc)Os::GetProcAddress(_oci_dll, "OCIErrorGet");
  _ociStmtFetch2 =
      (OCIStmtFetch2Func)Os::GetProcAddress(_oci_dll, "OCIStmtFetch2");
  _ociHandleAlloc =
      (OCIHandleAllocFunc)Os::GetProcAddress(_oci_dll, "OCIHandleAlloc");
  _ociHandleFree =
      (OCIHandleFreeFunc)Os::GetProcAddress(_oci_dll, "OCIHandleFree");
  _ociLobCharSetForm =
      (OCILobCharSetFormFunc)Os::GetProcAddress(_oci_dll, "OCILobCharSetForm");
  _ociLobCopy = (OCILobCopyFunc)Os::GetProcAddress(_oci_dll, "OCILobCopy");
  _ociLobCreateTemporary = (OCILobCreateTemporaryFunc)Os::GetProcAddress(
      _oci_dll, "OCILobCreateTemporary");
  _ociLobFreeTemporary = (OCILobFreeTemporaryFunc)Os::GetProcAddress(
      _oci_dll, "OCILobFreeTemporary");
  _ociLobGetLength2 =
      (OCILobGetLength2Func)Os::GetProcAddress(_oci_dll, "OCILobGetLength2");
  ...
  _ociLobWriteAppend =
      (OCILobWriteAppendFunc)Os::GetProcAddress(_oci_dll, "OCILobWriteAppend");
  _ociParamGet = (OCIParamGetFunc)Os::GetProcAddress(_oci_dll, "OCIParamGet");
  _ociServerAttach =
      (OCIServerAttachFunc)Os::GetProcAddress(_oci_dll, "OCIServerAttach");
  _ociServerDetach =
      (OCIServerDetachFunc)Os::GetProcAddress(_oci_dll, "OCIServerDetach");
  _ociSessionBegin =
      (OCISessionBeginFunc)Os::GetProcAddress(_oci_dll, "OCISessionBegin");
  _ociSessionEnd =
      (OCISessionEndFunc)Os::GetProcAddress(_oci_dll, "OCISessionEnd");
  _ociStmtExecute =
      (OCIStmtExecuteFunc)Os::GetProcAddress(_oci_dll, "OCIStmtExecute");
  _ociStmtPrepare =
      (OCIStmtPrepareFunc)Os::GetProcAddress(_oci_dll, "OCIStmtPrepare");
  _ociTransCommit =
      (OCITransCommitFunc)Os::GetProcAddress(_oci_dll, "OCITransCommit");

  // OCIArrayDescriptorAlloc function is not available in 10g Client (do not
  // check it)
  if (_ociAttrGet == NULL || _ociAttrSet == NULL || _ociAttrSet == NULL ||
      _ociBindByPos == NULL || _ociDefineByPos == NULL ||
      _ociDescriptorAlloc == NULL || _ociDescriptorFree == NULL ||
      _ociEnvCreate == NULL || _ociErrorGet == NULL ||
      _ociHandleAlloc == NULL || _ociHandleFree == NULL ||
      _ociLobCharSetForm == NULL || _ociLobCopy == NULL ||
      _ociLobCreateTemporary == NULL || _ociLobFreeTemporary == NULL ||
      _ociLobTrim == NULL || _ociLobWrite == NULL ||
      _ociLobWriteAppend == NULL || _ociParamGet == NULL ||
      _ociSessionBegin == NULL || _ociSessionEnd == NULL ||
      _ociServerAttach == NULL || _ociServerDetach == NULL ||
      _ociStmtPrepare == NULL || _ociStmtExecute == NULL ||
...
int SqlOciApi::Connect(size_t *time_spent) {
  ...
  sword rc = _ociEnvCreate((OCIEnv **)&_envhp, (ub4)OCI_THREADED, NULL, NULL,
                           NULL, NULL, 0, NULL);
  ...
  // Allocate handles
  rc = _ociHandleAlloc((dvoid *)_envhp, (dvoid **)&_errhp, OCI_HTYPE_ERROR, 0,
                       NULL);

  if (rc < 0)
    return rc;

  rc = _ociHandleAlloc((dvoid *)_envhp, (dvoid **)&_srvhp, OCI_HTYPE_SERVER, 0,
                       NULL);

  if (rc < 0)
    return rc;

  rc = _ociHandleAlloc((dvoid *)_envhp, (dvoid **)&_svchp, OCI_HTYPE_SVCCTX, 0,
                       NULL);

  if (rc < 0)
    return rc;

  rc = _ociServerAttach(_srvhp, _errhp, (text *)_db.c_str(), (sb4)_db.length(),
                        0);
  ...
  rc =
      _ociAttrSet(_svchp, OCI_HTYPE_SVCCTX, _srvhp, 0, OCI_ATTR_SERVER, _errhp);
  ...
  rc = _ociAttrSet(_authp, OCI_HTYPE_SESSION, (void *)_user.c_str(),
                   (ub4)_user.length(), OCI_ATTR_USERNAME, _errhp);
  rc = _ociAttrSet(_authp, OCI_HTYPE_SESSION, (void *)_pwd.c_str(),
                   (ub4)_pwd.length(), OCI_ATTR_PASSWORD, _errhp);

  rc = _ociSessionBegin(_svchp, _errhp, _authp, OCI_CRED_RDBMS, OCI_DEFAULT);

  // SessionBegin can return OCI_SUCCESS_WITH_INFO (code 1) when for example,
  // connected with the following warning ORA-28002: the password will expire
  // within 7 days
  if (rc < 0) {
    SetError();
  ...
  rc = _ociAttrGet(_envhp, OCI_HTYPE_ENV, &_charset_id, 0,
                   OCI_ATTR_ENV_CHARSET_ID, _errhp);

  rc = _ociAttrSet(_svchp, OCI_HTYPE_SVCCTX, _authp, 0, OCI_ATTR_SESSION,
                   _errhp);
...
int SqlOciApi::SetSession() {
  ...
  query = "ALTER SESSION SET NLS_TIMESTAMP_TZ_FORMAT = 'YYYY-MM-DD "
  ...
  // Force to use period (.) as decimal separator, by default it depends on
  // locale and , for many European and Latin America countries
...
void SqlOciApi::Deallocate() { Disconnect(); }
...
int SqlOciApi::ExecuteScalar(const char *query, int *result,
                             size_t *time_spent) {
  if (query == NULL || _ociHandleAlloc == NULL || _ociStmtPrepare == NULL ||
      _ociDefineByPos == NULL || _ociStmtExecute == NULL ||
      _ociHandleFree == NULL)
    return -1;
  ...
  int rc = _ociHandleAlloc((dvoid *)_envhp, (dvoid **)&stmtp, OCI_HTYPE_STMT, 0,
                           NULL);

  rc = _ociStmtPrepare(stmtp, _errhp, (text *)query, (ub4)strlen(query),
                       OCI_NTV_SYNTAX, OCI_DEFAULT);

  rc = _ociDefineByPos(stmtp, &defnpp, _errhp, 1, &q_result, sizeof(int),
                       SQLT_INT, NULL, NULL, NULL, OCI_DEFAULT);

  // Execute the statement
  rc =
      _ociStmtExecute(_svchp, stmtp, _errhp, 1, 0, NULL, NULL, OCI_EXACT_FETCH);
...
int SqlOciApi::OpenCursor(const char *query, size_t buffer_rows,
                          int buffer_memory, size_t *col_count,
                          size_t *allocated_array_rows, int *rows_fetched,
                          SqlCol **cols, size_t *time_spent, bool catalog_query,
                          std::list<SqlDataTypeMap> * /*dtmap*/) {
  if (query == NULL)
    return -1;
  ...
  int rc = _ociHandleAlloc((dvoid *)_envhp, (dvoid **)&_stmtp_cursor,
                           OCI_HTYPE_STMT, 0, NULL);

  // Prepare the query
  rc = _ociStmtPrepare(_stmtp_cursor, _errhp, (text *)query, (ub4)strlen(query),
                       OCI_NTV_SYNTAX, OCI_DEFAULT);

  // Execute the query
  rc = _ociStmtExecute(_svchp, _stmtp_cursor, _errhp, 0, 0, NULL, NULL,
                       OCI_DEFAULT);
  ...
  rc = _ociAttrGet(_stmtp_cursor, OCI_HTYPE_STMT, &_cursor_cols_count, 0,
                   OCI_ATTR_PARAM_COUNT, _errhp);
  ...
  for (int i = 0; i < _cursor_cols_count; i++) {
    ...
    rc = _ociParamGet(_stmtp_cursor, OCI_HTYPE_STMT, _errhp, (void **)&colhp,
                      (ub4)(i + 1));

    // Get the pointer to column name
    rc = _ociAttrGet(colhp, OCI_DTYPE_PARAM, (void *)&name, &size,
                     OCI_ATTR_NAME, _errhp);
    ...
    rc =
        _ociAttrGet(colhp, OCI_DTYPE_PARAM, (void *)&_cursor_cols[i]._native_dt,
                    0, OCI_ATTR_DATA_TYPE, _errhp);

    // Get column length in bytes for character and binary strings
    rc = _ociAttrGet(colhp, OCI_DTYPE_PARAM, (void *)&_cursor_cols[i]._len, 0,
                     OCI_ATTR_DATA_SIZE, _errhp);

    // Check if length ratio applied for VARCHAR2 and CHAR columns
    if ((_cursor_cols[i]._native_dt == SQLT_CHR ||
         _cursor_cols[i]._native_dt == SQLT_AFC) &&
        _char_length_ratio != 0.0 && !catalog_query)
      _cursor_cols[i]._len = _cursor_cols[i]._len * _char_length_ratio;

    if (_cursor_cols[i]._native_dt == SQLT_BLOB ||
        _cursor_cols[i]._native_dt == SQLT_CLOB) {
    ...
    // Get precision and scale for NUMBER(p,s), precision is 0 and scale is 129
    // for NUMBER
    rc =
        _ociAttrGet(colhp, OCI_DTYPE_PARAM, (void *)&_cursor_cols[i]._precision,
                    0, OCI_ATTR_PRECISION, _errhp);
    rc = _ociAttrGet(colhp, OCI_DTYPE_PARAM, (void *)&_cursor_cols[i]._scale, 0,
                     OCI_ATTR_SCALE, _errhp);

    // Get NOT NULL attribute
    ub1 nullable = 1;
    rc = _ociAttrGet(colhp, OCI_DTYPE_PARAM, (void *)&nullable, 0,
                     OCI_ATTR_IS_NULL, _errhp);
  ...
  for (int i = 0; i < _cursor_cols_count; i++) {
    // if data type is VARCHAR2 (SQLT_CHR) or CHAR (SQLT_AFC), bind to NULL
    // terminated string
    if (_cursor_cols[i]._native_dt == SQLT_CHR ||
        _cursor_cols[i]._native_dt == SQLT_AFC) {
      _cursor_cols[i]._native_fetch_dt = SQLT_STR;
      _cursor_cols[i]._fetch_len = _cursor_cols[i]._len + 1;
      _cursor_cols[i]._data =
          new char[_cursor_cols[i]._fetch_len * _cursor_allocated_rows];
    } else
      ...
      if (_cursor_cols[i]._native_dt == SQLT_NUM &&
        ...
        _cursor_cols[i]._native_fetch_dt = SQLT_STR;
        _cursor_cols[i]._fetch_len =
            42; // less value returns truncation error on max number
        _cursor_cols[i]._data =
            new char[_cursor_cols[i]._fetch_len * _cursor_allocated_rows];
      } else
        // If data type is NUMBER but precision is less than 10 and scale 0 then
        // bind to INT
        if (_cursor_cols[i]._native_dt == SQLT_NUM &&
            _cursor_cols[i]._precision < 10 && _cursor_cols[i]._scale == 0) {
          // Check whether target supports bind to INT or string has to be used
          if (_target_api_provider != NULL &&
              _target_api_provider->IsIntegerBulkBindSupported() == true) {
          ...
          if (_cursor_cols[i]._native_dt == SQLT_DAT) {
            ...
            _cursor_cols[i]._data =
                new char[_cursor_cols[i]._len * _cursor_allocated_rows];
            _cursor_cols[i]._fetch_len = _cursor_cols[i]._len;
          } else
            // Oracle TIMESTAMP, TIMESTAMP WITH TIME ZONE, INTERVAL DAY TO
            // SECOND and YEAR TO MONTH data types
            if (_cursor_cols[i]._native_dt == SQLT_TIMESTAMP ||
                _cursor_cols[i]._native_dt == SQLT_TIMESTAMP_TZ ||
                _cursor_cols[i]._native_dt == SQLT_INTERVAL_DS ||
                _cursor_cols[i]._native_dt == SQLT_INTERVAL_YM) {
              _cursor_cols[i]._native_fetch_dt = SQLT_STR;

              // Value is fetched as string with maximum 9 digit fraction,
              // allocate buffer to hold the largest value
              ...
              if (_cursor_cols[i]._native_dt == SQLT_BIN) {
                ...
                if (_cursor_cols[i]._native_dt == SQLT_BLOB ||
                  ...
                  if (_bind_long_inplace > 0) {
                    ...
                    _cursor_cols[i]._data =
                        new char[_bind_long_inplace * _cursor_allocated_rows];
                  } else {
                    _cursor_cols[i]._native_fetch_dt =
                        _cursor_cols[i]._native_dt;
                    _cursor_cols[i]._fetch_len = sizeof(OCILobLocator *);

                    _cursor_cols[i]._data = new char[sizeof(OCILobLocator *) *
                                                     _cursor_allocated_rows];

                    // Allocate LOB locators (OCIArrayDescriptorAlloc function
                    // is not available in 10g Client)
                    if (_ociArrayDescriptorAlloc != NULL)
                      rc = _ociArrayDescriptorAlloc(
                          _envhp, (void **)_cursor_cols[i]._data, OCI_DTYPE_LOB,
                          (ub4)_cursor_allocated_rows, 0, NULL);
                    else
                  ...
                  if (_cursor_cols[i]._native_dt == SQLT_LNG) {
                    ...
                    if (_cursor_cols[i]._native_dt == SQLT_NTY) {
                      ...
                      _cursor_cols[i]._fetch_len = _cursor_cols[i]._len;
                      _cursor_cols[i]._data =
                          new char[_cursor_cols[i]._fetch_len *
                                   _cursor_allocated_rows];
                    } else
                      // ROWID data type
    ...
    if (_cursor_cols[i]._data != NULL) {
      ...
      if (_bind_long_inplace == 0 && (_cursor_cols[i]._native_dt == SQLT_BLOB ||
                                      _cursor_cols[i]._native_dt == SQLT_CLOB))
        fetch_len = 0;

      rc = _ociDefineByPos(_stmtp_cursor, &defnpp, _errhp, (ub4)(i + 1),
                           _cursor_cols[i]._data, (sb4)fetch_len,
                           (ub2)_cursor_cols[i]._native_fetch_dt,
                           (ub2 *)_cursor_cols[i]._ind2,
  ...
  rc = _ociStmtFetch2(_stmtp_cursor, _errhp, (ub4)_cursor_allocated_rows,
  ...
  _ociAttrGet(_stmtp_cursor, OCI_HTYPE_STMT, (void *)&fetched, NULL,
              OCI_ATTR_ROWS_FETCHED, _errhp);
...
int SqlOciApi::Fetch(int *rows_fetched, size_t *time_spent) {
  if (_ociStmtFetch2 == NULL || _ociAttrGet == NULL ||
  ...
  // Fetch the data
  int rc = _ociStmtFetch2(_stmtp_cursor, _errhp, (ub4)_cursor_allocated_rows,
                          OCI_DEFAULT, 0, OCI_DEFAULT);
...
// Specifies whether API allows to parallel reading from this API and write to
// another API
...
int SqlOciApi::GetLobLength(size_t row, size_t column, size_t *length) {
  if (_cursor_cols == NULL || row >= _cursor_allocated_rows ||
      column >= _cursor_cols_count || _ociLobGetLength2 == NULL)
    return -1;
...
char *SqlOciApi::GetLobBuffer(size_t row, size_t column, size_t length,
                              size_t *alloc_len) {
  if (_cursor_cols == NULL || row >= _cursor_allocated_rows ||
      column >= _cursor_cols_count || length <= 0)
    return NULL;

  size_t buf_len = length;

  // For CLOB input length is in bytes, define buffer size according the
  // character set
...
// Get LOB content
int SqlOciApi::GetLobContent(size_t row, size_t column, void *data,
                             size_t length, int *len_ind) {
  if (data == NULL || _cursor_cols == NULL || _cursor_cols_count <= column ||
      _ociLobRead2 == NULL)
    return -1;
  ...
  // When reading CLOB containing one byte in UTF-8, and when byte_amtp is used,
  // input len must be 4, otherwise OCI_NEED_DATA returned. But after calling
  // OCILobRead2 len will contain 1 (number if bytes)

  // To read CLOB csfrm must be set to 0 or SQLCS_IMPLICIT in OCILobRead2 call;
  // to read NCLOB csfrm must be set SQLCS_NCHAR otherwise ORA-24806: LOB form
  // mismatch returned

  // Get SQLCS_IMPLICIT for CLOB and SQLCS_NCHAR for NCLOB locator (SQLT_CLOB
  // type is returned for both CLOB and NCLOB)
  if (_cursor_cols[column]._native_dt == SQLT_CLOB)
    rc = _ociLobCharSetForm(_envhp, _errhp, loc, &csfrm);

  // Read the LOB value
  rc = _ociLobRead2(_svchp, _errhp, loc, &len, NULL, 1, data, (oraub8)length,
...
int SqlOciApi::GetAvailableTables(std::string &select, std::string &exclude,
  ...
  GetSelectionCriteria(select.c_str(), exclude.c_str(), "owner", "table_name",
                       condition, _user.c_str(), true);

  // Build the query
  std::string query = "SELECT owner, table_name FROM all_tables WHERE";

  // Exclude overflow tables for index organized tables
  // In any case, user cannot access them directly, Oracle returns ORA-25191:
  // cannot reference overflow table of an index-organized table IOT_NAME column
  // available even in Oracle 9i
  ...
  if (strcmp(select.c_str(), "*.*") == 0) {
    query +=
        " AND owner NOT IN "
        "('APPQOSSYS','DBSNMP','CTXSYS','FLOWS_FILES','MDSYS','OUTLN','SYS',";
    query += " 'SYSTEM','XDB')";
  ...
  // Set prefetch count
  rc = _ociAttrSet(stmtp, OCI_HTYPE_STMT, (void *)&prefetch_rows, sizeof(int),
                   OCI_ATTR_PREFETCH_ROWS, _errhp);

  rc = _ociStmtPrepare(stmtp, _errhp, (text *)query.c_str(),
                       (ub4)query.length(), OCI_NTV_SYNTAX, OCI_DEFAULT);

  // Define the select list items
  rc = _ociDefineByPos(stmtp, &defnpp, _errhp, 1, (void *)owner, 31, SQLT_STR,
                       (void *)owner_ind, owner_len, owner_code, OCI_DEFAULT);
  rc = _ociDefineByPos(stmtp, &defnpp, _errhp, 2, (void *)table_name, 31,
                       SQLT_STR, (void *)table_name_ind, table_name_len,
                       table_name_code, OCI_DEFAULT);

  // Execute the statement and perform the initial fetch of 100 rows into the
  // defined array
  ...
  while (rc >= 0) {
    _ociAttrGet(stmtp, OCI_HTYPE_STMT, (void *)&fetched, NULL,
                OCI_ATTR_ROWS_FETCHED, _errhp);

    // OCI_NO_DATA is returned by OCIStmtExecute and OCIStmtFetch2 when the
    // number of fetched rows is less than the number of rows allocated in the
    // array
    if (fetched == 0)
      break;
...
int SqlOciApi::ReadSchema(const char *select, const char *exclude,
                          bool read_cns, bool read_idx) {
  ...
  GetSelectionCriteria(select, exclude, "owner", "table_name", selection,
                       _user.c_str(), true);
  GetSelectionCriteria(select, exclude, "table_owner", "table_name", selection2,
                       _user.c_str(), true);
...
int SqlOciApi::ReadSchemaForTransferTo(const char * /*select*/,
                                       const char * /*exclude*/) {
  // Leave the filter empty as it is unknown how source objects are mapped to
  // target objects
  std::string selection;
...
int SqlOciApi::ReadTableColumns(std::string &selection) {
  ...
  int rc = OpenCursor(query.c_str(), 100, 0, &col_count, &allocated_rows,
                      &rows_fetched, &cols, &time_read);
  ...
  while (rc >= 0) {
    ...
    for (int i = 0; i < rows_fetched; i++) {
      ...
      if (cols[0]._ind2[i] != -1) {
        ...
        strncpy(col_meta.schema, cols[0]._data + cols[0]._fetch_len * i,
                (size_t)cols[0]._len_ind2[i]);
      ...
      if (cols[1]._ind2[i] != -1) {
        ...
        strncpy(col_meta.table, cols[1]._data + cols[1]._fetch_len * i,
                (size_t)cols[1]._len_ind2[i]);
      ...
      if (cols[2]._ind2[i] != -1) {
        ...
        strncpy(col_meta.column, cols[2]._data + cols[2]._fetch_len * i,
                (size_t)cols[2]._len_ind2[i]);
      ...
      if (cols[3]._ind2[i] != -1) {
        ...
        strncpy(col_meta.data_type, cols[3]._data + cols[3]._fetch_len * i,
                (size_t)cols[3]._len_ind2[i]);
      ...
      if (cols[4]._ind2[i] != -1) {
        ...
        strncpy(col_meta.default_value, cols[4]._data + cols[4]._fetch_len * i,
                (size_t)cols[4]._len_ind2[i]);
  ...
  // Set pointer to NULL to avoid delete if destructor (values belong to list
  // now)
  col_meta.schema = NULL;
  col_meta.table = NULL;
  col_meta.column = NULL;
...
int SqlOciApi::ReadTableConstraints(std::string &selection, const char *types) {
  ...
  while (rc >= 0) {
    ...
    for (int i = 0; i < rows_fetched; i++) {
      ...
      // Get constraint type
      col_cns.type = (cols[3]._ind2[i] != -1)
                         ? *(cols[3]._data + cols[3]._fetch_len * i)
                         : '\x0';

      // If it is a CHECK constraint, skip "COL_NAME" IS NOT NULL
      if (col_cns.type == 'C') {
        char *data = (cols[4]._ind2[i] != -1)
                         ? (cols[4]._data + cols[4]._fetch_len * i)
                         : NULL;
      ...
      if (cols[0]._ind2[i] != -1) {
        ...
        strncpy(col_cns.schema, cols[0]._data + cols[0]._fetch_len * i,
                (size_t)cols[0]._len_ind2[i]);
      ...
      if (cols[1]._ind2[i] != -1) {
        ...
        strncpy(col_cns.table, cols[1]._data + cols[1]._fetch_len * i,
                (size_t)cols[1]._len_ind2[i]);
      ...
      if (cols[2]._ind2[i] != -1) {
        ...
        strncpy(col_cns.constraint, cols[2]._data + cols[2]._fetch_len * i,
                (size_t)cols[2]._len_ind2[i]);
      ...
      if (col_cns.type == 'R' && cols[5]._ind2[i] != -1) {
        ...
        strncpy(col_cns.r_schema, cols[5]._data + cols[5]._fetch_len * i,
                (size_t)cols[5]._len_ind2[i]);
        col_cns.r_schema[cols[5]._len_ind2[i]] = '\x0';
      }

      // Reference (primary key or unique) constraint name for foreign key
      // constraints
      if (col_cns.type == 'R' && cols[6]._ind2[i] != -1) {
        col_cns.r_constraint = new char[(size_t)cols[6]._len_ind2[i] + 1];

        strncpy(col_cns.r_constraint, cols[6]._data + cols[6]._fetch_len * i,
                (size_t)cols[6]._len_ind2[i]);
...
int SqlOciApi::ReadConstraintColumns(std::string &selection) {
  // In Oracle, constraint name is unique within the schema (owner), no need to
  // sort by table name
  ...
  while (rc >= 0) {
    ...
    for (int i = 0; i < rows_fetched; i++) {
      ...
      if (cols[3]._ind2[i] != -1) {
        ...
        strncpy(col_cns.column, cols[3]._data + cols[3]._fetch_len * i,
                (size_t)cols[3]._len_ind2[i]);
...
int SqlOciApi::ReadConstraintTable(const char *schema, const char *constraint,
                                   std::string &table) {
  ...
  int rc = OpenCursor(query.c_str(), 1, 0, &col_count, &allocated_rows,
                      &rows_fetched, &cols, &time_read);
...
int SqlOciApi::ReadConstraintColumns(const char *schema, const char *table,
  ...
  while (rc >= 0) {
    ...
    for (int i = 0; i < rows_fetched; i++) {
      ...
      if (cols[0]._ind2[i] != -1) {
        ...
        strncpy(comment.schema, cols[0]._data + cols[0]._fetch_len * i,
                (size_t)cols[0]._len_ind2[i]);
      ...
      if (cols[1]._ind2[i] != -1) {
        ...
        strncpy(comment.table, cols[1]._data + cols[1]._fetch_len * i,
                (size_t)cols[1]._len_ind2[i]);
      ...
      if (cols[2]._ind2[i] != -1) {
        ...
        strncpy(comment.column, cols[2]._data + cols[2]._fetch_len * i,
                (size_t)cols[2]._len_ind2[i]);
      ...
      // Column type
      if (cols[3]._ind2[i] != -1) {
        if (strncmp(cols[3]._data + cols[3]._fetch_len * i, "TABLE",
                    (size_t)cols[3]._len_ind2[i]) == 0)
          comment.type = 'T';
      } else
        comment.type = 'C';
      ...
      if (cols[4]._ind2[i] != -1) {
        ...
        strncpy(comment.comment, cols[4]._data + cols[4]._fetch_len * i,
                (size_t)cols[4]._len_ind2[i]);
...
int SqlOciApi::ReadIndexes(std::string &selection) {
  // Generated='Y' means that name is generated, not index itself, so if
  // CONSTRAINT name is given for PRIMARY KEY and UNIQUE generated contains 'N'
  // and additional check required
  std::string query =
  ...
  while (rc >= 0) {
    ...
    for (int i = 0; i < rows_fetched; i++) {
      ...
      if (cols[0]._ind2[i] != -1) {
        ...
        strncpy(idx.schema, cols[0]._data + cols[0]._fetch_len * i,
                (size_t)cols[0]._len_ind2[i]);
      ...
      if (cols[1]._ind2[i] != -1) {
        ...
        strncpy(idx.index, cols[1]._data + cols[1]._fetch_len * i,
                (size_t)cols[1]._len_ind2[i]);
      ...
      if (cols[2]._ind2[i] != -1) {
        ...
        strncpy(idx.t_schema, cols[2]._data + cols[2]._fetch_len * i,
                (size_t)cols[2]._len_ind2[i]);
      ...
      if (cols[3]._ind2[i] != -1) {
        ...
        strncpy(idx.t_name, cols[3]._data + cols[3]._fetch_len * i,
                (size_t)cols[3]._len_ind2[i]);
      ...
      // Uniqueness
      if (cols[4]._ind2[i] != -1 &&
          strncmp(cols[4]._data + cols[4]._fetch_len * i, "UNIQUE", 6) == 0)
        idx.unique = true;
      else
        idx.unique = false;
      ...
      // For unique indexes make sure there is no unique constraint with the
      // same name
      if (idx.unique) {
        SqlConstraints *cns =
            GetConstraint(idx.t_schema, idx.t_name, idx.index);
  ...
  while (rc >= 0) {
    ...
    for (int i = 0; i < rows_fetched; i++) {
      ...
      if (cols[2]._ind2[i] != -1) {
        ...
        strncpy(idx.column, cols[2]._data + cols[2]._fetch_len * i,
                (size_t)cols[2]._len_ind2[i]);
      ...
      if (cols[3]._ind2[i] != -1 &&
          strncmp(cols[3]._data + cols[3]._fetch_len * i, "DESC", 4) == 0)
        idx.asc = false;
      else
        idx.asc = true;
  ...
  while (rc >= 0) {
    ...
    for (int i = 0; i < rows_fetched; i++) {
      ...
      if (cols[2]._ind2[i] != -1) {
        ...
        strncpy(idx.expression, cols[2]._data + cols[2]._fetch_len * i,
                (size_t)cols[2]._len_ind2[i]);
...
int SqlOciApi::GetKeyConstraintColumns(SqlConstraints &cns,
  ...
  for (std::list<SqlConsColumns>::iterator i = _table_cons_columns.begin();
       i != _table_cons_columns.end(); i++) {
    char *s = (*i).schema;
    char *t = (*i).table;
    char *c = (*i).constraint;
    char *col = (*i).column;
    ...
    if (strcmp(cns.constraint, c) == 0 && strcmp(cns.table, t) == 0 &&
        strcmp(cns.schema, s) == 0) {
      output.push_back(col);
      found = true;

      // Find data type
      if (types != NULL) {
        for (std::list<SqlColMeta>::iterator m = _table_columns.begin();
             m != _table_columns.end(); m++) {
          char *cs = (*m).schema;
          char *ct = (*m).table;
          char *ccol = (*m).column;
          char *dt = (*m).data_type;
          ...
          if (strcmp(cs, s) == 0 && strcmp(ct, t) == 0 &&
              strcmp(ccol, col) == 0) {
            if (!_stricmp(dt, "CHAR") || !_stricmp(dt, "VARCHAR2") ||
                !_stricmp(dt, "VARCHAR"))
...
int SqlOciApi::GetIndexColumns(SqlIndexes &idx,
                               std::list<std::string> &idx_cols,
                               std::list<std::string> &idx_sorts) {
  int c = 0;

  // Find index columns
  for (std::list<SqlIndColumns>::iterator i = _table_ind_columns.begin();
       i != _table_ind_columns.end(); i++) {
    ...
    if ((*i).schema != NULL && strcmp((*i).schema, idx.schema) == 0 &&
      ...
      if ((*i).asc == false && strncmp((*i).column, "SYS_NC0", 7) == 0) {
        ...
        for (std::list<SqlIndExp>::iterator k = _table_ind_expressions.begin();
             k != _table_ind_expressions.end(); k++) {
...
int SqlOciApi::GetColumnDefault(const char *table, const char *column,
  ...
  /*for(std::list<SqlColMeta>::iterator i = _table_columns.begin(); i !=
  _table_columns.end(); i++)
  {
          if((*i).no_default)
                  continue;
          ...
          // Table found
          if(s != NULL && t != NULL && strcmp(s, schema.c_str()) == 0 &&
  strcmp(t, object.c_str()) == 0)
          {
                  // Column found
                  if(column != NULL && c != NULL && cm != NULL && strcmp(c,
  column) == 0)
                  {
                          comment = cm;
                          break;
                  ...
                  // Table comment
                  if(column == NULL && c == NULL && cm != NULL && (*i).type ==
  'T')
                  {
                          comment = cm;
                          break;
...
int SqlOciApi::GetComment(const char *table, const char *column,
                          std::string &comment) {
  ...
  // Find table columns (already ordered by column number)
  for (std::list<SqlComments>::iterator i = _table_comments.begin();
       i != _table_comments.end(); i++) {
    char *s = (*i).schema;
    char *t = (*i).table;
    char *c = (*i).column;
    char *cm = (*i).comment;
...
int SqlOciApi::ReadSequences(std::string &selection) {
  ...
  std::string query = "SELECT sequence_owner, sequence_name, min_value, "
                      "max_value, increment_by, last_number, cache_size, "
                      "cycle_flag "
                      "FROM all_sequences ";
  ...
  while (rc >= 0) {
    ...
    for (int i = 0; i < rows_fetched; i++) {
      ...
      if (cols[0]._ind2[i] != -1) {
        ...
        strncpy(seq.schema, cols[0]._data + cols[0]._fetch_len * i,
                (size_t)cols[0]._len_ind2[i]);
      ...
      if (cols[1]._ind2[i] != -1) {
        ...
        strncpy(seq.name, cols[1]._data + cols[1]._fetch_len * i,
                (size_t)cols[1]._len_ind2[i]);
      ...
      if (cols[2]._ind2[i] != -1) {
        ...
        strncpy(seq.min_str, cols[2]._data + cols[2]._fetch_len * i,
                (size_t)cols[2]._len_ind2[i]);
      ...
      if (cols[3]._ind2[i] != -1) {
        ...
        strncpy(seq.max_str, cols[3]._data + cols[3]._fetch_len * i,
                (size_t)cols[3]._len_ind2[i]);
      ...
      if (cols[4]._ind2[i] != -1) {
        ...
        strncpy(seq.inc_str, cols[4]._data + cols[4]._fetch_len * i,
                (size_t)cols[4]._len_ind2[i]);
      ...
      if (cols[5]._ind2[i] != -1) {
        ...
        strncpy(seq.cur_str, cols[5]._data + cols[5]._fetch_len * i,
                (size_t)cols[5]._len_ind2[i]);
      ...
      if (cols[6]._ind2[i] != -1) {
        ...
        strncpy(seq.cache_size_str, cols[6]._data + cols[6]._fetch_len * i,
                (size_t)cols[6]._len_ind2[i]);
...
int SqlOciApi::InitBulkTransfer(const char *table, size_t col_count,
                                size_t allocated_array_rows, SqlCol *s_cols,
                                SqlCol ** /*t_cols*/) {
  TRACE("OCI InitBulkTransfer() Entered");
  TRACE_P("Target table: %s", table);

  // Allocate statement handle
  int rc = _ociHandleAlloc((dvoid *)_envhp, (dvoid **)&_stmtp_insert,
                           OCI_HTYPE_STMT, 0, NULL);
  ...
  *c = '\x0';
  ...
  // Prepare the insert
  rc = _ociStmtPrepare(_stmtp_insert, _errhp, (text *)insert.c_str(),
                       (ub4)insert.length(), OCI_NTV_SYNTAX, OCI_DEFAULT);
  ...
  // Bind columns (allocate indicators even if the source data not bound, NULL
  // will be inserted)
  for (int i = 0; i < col_count; i++) {
    short *ind = NULL;
    ...
    if (_source_api_type == SQLDATA_ORACLE)
      ...
      if ( // ODBC SQL_LONGVARCHAR (CLOB) is read as SQL_C_CHAR, so skip it
        ...
        // Bind without terminating \x0, it fetched if SQL_C_CHAR but not
        // included to fetched length
        _ins_cols[i]._native_dt = SQLT_AFC;
      } else
        // VARBINARY
        if ( // ODBC SQL_LONGVARBINARY (BLOB) is read as SQL_C_BINARY, so skip
             // it
            s_cols[i]._lob == false &&
                // SQL Server, Informix, DB2 and Sybase ASA types fetched as
                // BINARY
                ((_source_api_type == SQLDATA_SQL_SERVER ||
                  _source_api_type == SQLDATA_INFORMIX ||
                  _source_api_type == SQLDATA_DB2 ||
            ...
            // Sybase ASE BINARY
            (_source_api_type == SQLDATA_SYBASE &&
             s_cols[i]._native_fetch_dt == CS_BINARY_TYPE)) {
          _ins_cols[i]._native_dt = SQLT_BIN;
        } else
          // Sybase CHAR and VARCHAR
          if (_source_api_type == SQLDATA_SYBASE &&
              (s_cols[i]._native_fetch_dt == CS_CHAR_TYPE ||
               s_cols[i]._native_fetch_dt == CS_LONGCHAR_TYPE)) {
            // Bind without terminating NULL (it required in case of SQLT_STR)
            _ins_cols[i]._native_dt = SQLT_AFC;
          } else
            // Sybase UNICHAR
            if (_source_api_type == SQLDATA_SYBASE &&
                s_cols[i]._native_fetch_dt == CS_UNICHAR_TYPE) {
              // Bind without terminating NULL (it required in case of SQLT_STR)
              _ins_cols[i]._native_dt = SQLT_AFC;
            } else
              // INTEGER
              if (((_source_api_type == SQLDATA_SQL_SERVER ||
                    _source_api_type == SQLDATA_DB2 ||
                    _source_api_type == SQLDATA_INFORMIX ||
                    _source_api_type == SQLDATA_ASA) &&
                   s_cols[i]._native_fetch_dt == SQL_C_LONG) ||
                  (_source_api_type == SQLDATA_SYBASE &&
                   s_cols[i]._native_fetch_dt == CS_INT_TYPE)) {
                _ins_cols[i]._native_dt = SQLT_INT;
              } else
                // SQL Server DATETIME
                // Informix DATETIME bound to timestamp struct to support all
                // unit ranges (HOUR TO SECOND i.e) Sybase ASA DATETIME with
                // fraction
                if ((_source_api_type == SQLDATA_SQL_SERVER ||
                     _source_api_type == SQLDATA_DB2 ||
                     _source_api_type == SQLDATA_INFORMIX ||
                  ...
                  // Bind to string with full format 'YYYY-MM-DD
                  // HH:MI:SS.FFFFFF' Terminated by '\x0' to align multirow
                  // buffers
                  _ins_cols[i]._native_dt = SQLT_STR;
                  _ins_cols[i]._fetch_len = 26 + 1;

                  // Allocate data for the timestamp string (conversion will
                  // happen on transfer) Space for terminating 0 is required in
                  // the buffer for sprintf function
                  _ins_cols[i]._data =
                      new char[_ins_cols[i]._fetch_len * _ins_allocated_rows];
                  data = _ins_cols[i]._data;
                } else
                  // Informix TEXT, CLOB, BYTE and BLOB (fetched as
                  // SQL_C_CHAR/SQL_C_BINARY) MySQL TEXT and BLOB data types;
                  ...
                  if ((_source_api_type == SQLDATA_INFORMIX ||
                    ...
                    if ((_source_api_type == SQLDATA_INFORMIX &&
                         (s_cols[i]._native_dt == SQL_LONGVARBINARY ||
                          s_cols[i]._native_dt == -102)) ||
                        // Sybase ASA LONG VARBINARY
                        (_source_api_type == SQLDATA_ASA &&
                         s_cols[i]._native_dt == SQL_LONGVARBINARY) ||
                        // MySQL BLOB, LONGBLOB
                        (_source_api_type == SQLDATA_MYSQL &&
                         s_cols[i]._binary == true)) {
                    ...
                    rc = _ociDescriptorAlloc(_envhp,
                                             (void **)&_ins_cols[i]._data,
                                             OCI_DTYPE_LOB, 0, NULL);

                    // Temporary LOB for inserting data
                    rc = _ociLobCreateTemporary(
                        _svchp, _errhp, (OCILobLocator *)_ins_cols[i]._data, 0,
                        SQLCS_IMPLICIT, lobtype, OCI_ATTR_NOCACHE,
                    ...
                    if (_source_api_type == SQLDATA_SYBASE &&
                        s_cols[i]._native_fetch_dt == CS_UNITEXT_TYPE) {
                      _ins_cols[i]._native_dt = SQLT_CLOB;
                      _ins_cols[i]._fetch_len = 0;
                      ...
                      // Temporary LOB for inserting data
                      rc = _ociLobCreateTemporary(
                          _svchp, _errhp, (OCILobLocator *)_ins_cols[i]._data,
                          0, SQLCS_NCHAR, OCI_TEMP_CLOB, OCI_ATTR_NOCACHE,
                          OCI_DURATION_SESSION);
    ...
    // Bind the column
    rc = _ociBindByPos(
        _stmtp_insert, &bindpp, _errhp, (ub4)(i + 1), data,
        (sb4)_ins_cols[i]._fetch_len, (ub2)_ins_cols[i]._native_dt, ind,
        (ub2 *)_ins_cols[i]._len_ind2, NULL, 0, NULL, OCI_DEFAULT);
    ...
    if (_ins_cols[i]._nchar) {
      ...
      rc = _ociAttrSet(bindpp, OCI_HTYPE_BIND, (void *)&cform, 0,
                       OCI_ATTR_CHARSET_FORM, _errhp);
      rc = _ociAttrSet(bindpp, OCI_HTYPE_BIND, (void *)&csid, 0,
                       OCI_ATTR_CHARSET_ID, _errhp);
    }
...
int SqlOciApi::TransferRows(SqlCol *s_cols, int rows_fetched, int *rows_written,
                            size_t *bytes_written, size_t *time_spent) {
  size_t bytes = 0;
  int rc = 0;
  ...
  for (int i = 0; i < rows_fetched; i++) {
    for (int k = 0; k < _ins_cols_count; k++) {
      if (_source_api_type == SQLDATA_DB2 ||
          _source_api_type == SQLDATA_SQL_SERVER ||
          _source_api_type == SQLDATA_INFORMIX ||
          _source_api_type == SQLDATA_MYSQL ||
          _source_api_type == SQLDATA_ASA) {
        ...
        if (_source_api_type ==
            SQLDATA_DB2 /*&& s_cols[k].ind[0] & 0xFFFFFFFF00000000*/)
        ...
        if (ind != -1) {
          ...
          // Source indicator can contain value larger than fetch size in case
          // if data truncated warning risen (Informix when LOB fecthed as
          // VARCHAR)
      ...
      // SQL Server, Informix and Sybase ASA DATETIME; DB2 TIMESTAMP bound to
      // struct
      if ((_source_api_type == SQLDATA_SQL_SERVER ||
           _source_api_type == SQLDATA_DB2 ||
           _source_api_type == SQLDATA_INFORMIX ||
           _source_api_type == SQLDATA_ASA) &&
          s_cols[k]._native_fetch_dt == SQL_TYPE_TIMESTAMP &&
          _ins_cols[k]._ind2[i] != -1) {
        ...
        SQL_TIMESTAMP_STRUCT *ts =
            (SQL_TIMESTAMP_STRUCT *)(s_cols[k]._data + offset);

        long fraction = (long)ts->fraction;

        // In ODBC, fraction is stored in nanoseconds, but now we support only
        // microseconds
        fraction = fraction / 1000;

        // Convert SQL_TIMESTAMP_STRUCT to string
        Str::SqlTs2Str((short)ts->year, (short)ts->month, (short)ts->day,
                       (short)ts->hour, (short)ts->minute, (short)ts->second,
                       fraction, _ins_cols[k]._data + ins_len * i);

        _ins_cols[k]._ind2[i] = 0;
        _ins_cols[k]._len_ind2[i] = (short)ins_len;
      }
      // Sybase ASE DATE fetched as full 26 byte timestamp string and must be
      // truncated to Oracle DATE length otherwise Oracle returns "ORA-01830:
      // date format picture ends before converting entire input string"
      else if (_source_api_type == SQLDATA_SYBASE &&
               s_cols[k]._native_dt == CS_DATE_TYPE) {
        ...
        // LOB column
        if (_source_api_type != SQLDATA_ORACLE && s_cols[k]._lob == true &&
            _ins_cols[k]._ind2[i] != -1) {
          ...
          while (more) {
            ...
            // Check if the buffer fully filled (buffer is x0 terminated for
            // CLOBs)
            if (((_source_api_type == SQLDATA_INFORMIX &&
                      (s_cols[k]._native_dt == SQL_LONGVARCHAR ||
                       s_cols[k]._native_dt == -103) ||
                  // Sybase ASA LONG VARCHAR
                  (_source_api_type == SQLDATA_ASA &&
                   s_cols[k]._native_dt == SQL_LONGVARCHAR)) &&
                ...
                ((_source_api_type == SQLDATA_INFORMIX &&
                      (s_cols[k]._native_dt == SQL_LONGVARBINARY ||
                       s_cols[k]._native_dt == -102) ||
                  // Sybase ASA LONG VARBINARY
                  (_source_api_type == SQLDATA_ASA &&
                   s_cols[k]._native_dt == SQL_LONGVARBINARY)) &&
                 (size_t)s_cols[k].ind[i] == s_cols[k]._fetch_len)) {
              piece =
                  (lob_size == 0) ? (ub1)OCI_FIRST_PIECE : (ub1)OCI_NEXT_PIECE;
              ampt = 0;
            } else
              // MySQL API returns LOB in one piece
              if (_source_api_type == SQLDATA_MYSQL &&
                  s_cols[k]._native_dt == MYSQL_TYPE_BLOB) {
                piece = OCI_ONE_PIECE;
                ampt = (ub4)s_cols[k].ind[i];
              } else
                piece =
                    (lob_size == 0) ? (ub1)OCI_ONE_PIECE : (ub1)OCI_LAST_PIECE;

            // Write LOB chunk
            rc = _ociLobWrite(_svchp, _errhp, loc, &ampt, (ub4)(lob_size + 1),
                              s_cols[k]._data, (ub4)s_cols[k].ind[i], piece,
            ...
            if (piece == OCI_FIRST_PIECE || piece == OCI_NEXT_PIECE) {
              rc =
                  _source_api_provider->GetLobPart(0, (size_t)k, NULL, 0, NULL);
          ...
          // Correct the size for UTF-16 data since buffer in bytes while Oracle
          // OCI requires size in characters
  ...
  // Insert rows
  rc = _ociStmtExecute(_svchp, _stmtp_insert, _errhp, (ub4)rows_fetched, 0,
...
int SqlOciApi::CloseBulkTransfer() {
  ...
  for (int i = 0; i < _ins_cols_count; i++) {
    ...
    if (_ins_cols[i]._lob == true) {
      rc = _ociLobFreeTemporary(_svchp, _errhp,
                                (OCILobLocator *)_ins_cols[i]._data);
...
// Get the maximum size of a character in the client character set in bytes (4
// for UTF-8)
...
// Drop the table
int SqlOciApi::DropTable(const char *table, size_t *time_spent,
                         std::string &drop_stmt) {
  // Although foreign keys are removed before transfer, CASCADE CONSTRAINTS is
  // required if non-selected tables have references to this table
...
// Foreign keys are removed before transfer as CASCADE CONSTRAINTS causes
// 'resource busy' errors in concurrent environment
...
int SqlOciApi::DropReferences(const char *table, size_t *time_spent) {
  ...
  for (std::list<SqlConstraints>::iterator i = _table_constraints.begin();
       i != _table_constraints.end(); i++) {
    ...
    // Not this table (compare case-insensitive as objects in DDL can be in any
    // case)
    ...
    for (std::list<SqlConstraints>::iterator k = _table_constraints.begin();
         k != _table_constraints.end(); k++) {
      if ((*k).type != 'R')
        continue;
      ...
      if (fk_s == NULL || fk_t == NULL || fk_c == NULL || pk_s == NULL ||
          pk_c == NULL)
        continue;
...
int SqlOciApi::DropReferencesChild(const char *table, size_t *time_spent,
                                   int *keys) {
  if (table == NULL)
    return -1;
...
void SqlOciApi::GetAllTablesQuery(std::string &table_template,
                                  std::string &query,
                                  const char *default_schema) {
  std::string selection;

  // Build WHERE clause to select rows from catalog
  GetSelectionCriteria(table_template.c_str(), "owner", "table_name", selection,
                       default_schema, true);
...
void SqlOciApi::SetVersion() {
  // Oracle 11g R2 Express returns - Oracle Database 11g Express Edition
  // Release 11.2.0.2.0 - Beta
  const char *query =
  ...
  // Open cursor
  int rc = OpenCursor(query, 1, 0, &col_count, &allocated_rows, &rows_fetched,
                      &cols, &time_read, true);
  ...
  if (rc >= 0) {
    ...
    if (cols != NULL && cols[0]._ind2 != NULL && cols[0]._len_ind2 != NULL &&
        cols[0]._ind2[0] != -1)
...
void SqlOciApi::SetError() {
  ...
  _ociErrorGet(_errhp, 1, NULL, &_native_error, (text *)_native_error_text,
               1024, OCI_HTYPE_ERROR);
...
void SqlOciApi::FindOraclePaths() {
  ...
  // Oracle 11g Express contains subkey KEY_XE; Oracle 11g Enterprise
  // KEY_OraDb11g_home1; Oracle 12 - KEY_OraDB12Home1 Oraclle 11g Client
  // KEY_OraClient11g_home1
  int rc = RegOpenKeyEx(HKEY_LOCAL_MACHINE, "Software\\Oracle", 0,
  ...
  while (more) {
    ...
    rc = RegQueryValueEx(hSubkey, "ORACLE_HOME", NULL, NULL, (LPBYTE)value,
                         (LPDWORD)&value_size);
