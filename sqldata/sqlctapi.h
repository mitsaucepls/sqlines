...
typedef CS_RETCODE(CS_PUBLIC *cs_ctx_allocFunc)(CS_INT version,
                                                CS_CONTEXT **outptr);
typedef CS_RETCODE(CS_PUBLIC *cs_configFunc)(CS_CONTEXT *context, CS_INT action,
                                             CS_INT property, CS_VOID *buf,
                                             CS_INT buflen, CS_INT *outlen);
typedef CS_RETCODE(CS_PUBLIC *cs_ctx_dropFunc)(CS_CONTEXT *context);
typedef CS_RETCODE(CS_PUBLIC *cs_dt_infoFunc)(CS_CONTEXT *context,
                                              CS_INT action, CS_LOCALE *locale,
                                              CS_INT type, CS_INT item,
                                              CS_VOID *buffer, CS_INT buflen,
                                              CS_INT *outlen);
typedef CS_RETCODE(CS_PUBLIC *cs_loc_allocFunc)(CS_CONTEXT *context,
                                                CS_LOCALE **loc_pointer);
typedef CS_RETCODE(CS_PUBLIC *cs_localeFunc)(CS_CONTEXT *context, CS_INT action,
                                             CS_LOCALE *locale, CS_INT type,
                                             CS_CHAR *buffer, CS_INT buflen,
                                             CS_INT *outlen);
typedef CS_RETCODE(CS_PUBLIC *ct_bindFunc)(CS_COMMAND *cmd, CS_INT item,
                                           CS_DATAFMT *datafmt, CS_VOID *buf,
                                           CS_INT *outputlen,
                                           CS_SMALLINT *indicator);
typedef CS_RETCODE(CS_PUBLIC *ct_cancelFunc)(CS_CONNECTION *connection,
                                             CS_COMMAND *cmd, CS_INT type);
typedef CS_RETCODE(CS_PUBLIC *ct_commandFunc)(CS_COMMAND *cmd, CS_INT type,
                                              CS_CHAR *buf, CS_INT buflen,
                                              CS_INT option);
typedef CS_RETCODE(CS_PUBLIC *ct_con_allocFunc)(CS_CONTEXT *context,
                                                CS_CONNECTION **connection);
typedef CS_RETCODE(CS_PUBLIC *ct_con_dropFunc)(CS_CONNECTION *connection);
typedef CS_RETCODE(CS_PUBLIC *ct_con_propsFunc)(CS_CONNECTION *connection,
                                                CS_INT action, CS_INT prop,
                                                CS_VOID *buf, CS_INT buflen,
                                                CS_INT *outlen);
typedef CS_RETCODE(CS_PUBLIC *ct_connectFunc)(CS_CONNECTION *connection,
                                              CS_CHAR *server_name,
                                              CS_INT snamelen);
typedef CS_RETCODE(CS_PUBLIC *ct_closeFunc)(CS_CONNECTION *connection,
                                            CS_INT option);
typedef CS_RETCODE(CS_PUBLIC *ct_cmd_allocFunc)(CS_CONNECTION *connection,
                                                CS_COMMAND **cmdptr);
typedef CS_RETCODE(CS_PUBLIC *ct_cmd_dropFunc)(CS_COMMAND *cmd);
typedef CS_RETCODE(CS_PUBLIC *ct_describeFunc)(CS_COMMAND *cmd, CS_INT item,
                                               CS_DATAFMT *datafmt);
typedef CS_RETCODE(CS_PUBLIC *ct_diagFunc)(CS_CONNECTION *connection,
                                           CS_INT operation, CS_INT type,
                                           CS_INT idx, CS_VOID *buffer);
typedef CS_RETCODE(CS_PUBLIC *ct_exitFunc)(CS_CONTEXT *context, CS_INT option);
typedef CS_RETCODE(CS_PUBLIC *ct_fetchFunc)(CS_COMMAND *cmd, CS_INT type,
                                            CS_INT offset, CS_INT option,
                                            CS_INT *count);
typedef CS_RETCODE(CS_PUBLIC *ct_initFunc)(CS_CONTEXT *context, CS_INT version);
typedef CS_RETCODE(CS_PUBLIC *ct_res_infoFunc)(CS_COMMAND *cmd,
                                               CS_INT operation, CS_VOID *buf,
                                               CS_INT buflen, CS_INT *outlen);
typedef CS_RETCODE(CS_PUBLIC *ct_resultsFunc)(CS_COMMAND *cmd,
                                              CS_INT *result_type);
...
public:
  ...
  virtual void GetCatalogSelectionCriteria(std::string &selection_template,
                                           std::string &output);
