...
Highlighter::Highlighter(QTextDocument *parent) : QSyntaxHighlighter(parent) {
  ...
  keywordPatterns << "alter" << "and" << "as" << "autoincrement"
                  << "begin" << "between" << "bigint" << "binary"
                  << "cascade" << "char" << "check" << "close" << "comment"
                  << "commit"
                  << "constraint"
                  << "create" << "cursor"
                  << "date" << "datetime" << "day" << "deallocate " << "declare"
                  << "default"
                  << "delete" << "double"
                  << "drop"
                  << "else" << "end" << "exception" << "exists" << "exit"
                  << "fetch" << "for" << "foreach" << "foreign" << "from"
                  << "function"
                  << "handler"
                  << "if" << "in" << "index" << "insert" << "int" << "into"
                  << "is"
                  << "go"
                  << "key"
                  << "like"
                  << "long" << "loop"
                  << "money"
                  << "nchar" << "null" << "number" << "numeric" << "nvarchar"
                  << "nvarchar2"
                  << "on" << "open" << "or"
                  << "primary" << "procedure"
                  << "references" << "replace" << "restrict" << "return"
                  << "returns" << "returning"
                  << "select" << "set"
                  << "short" << "signed" << "smallint" << "smallmoney"
                  << "table" << "then" << "time" << "timestamp"
                  << "union" << "unique" << "uniqueidentifier" << "unsigned"
                  << "update"
