...
CentralWidget::CentralWidget(bool lineNumberEnabled, bool highlighterEnabled,
                             bool wrappingEnabled, QWidget *parent) noexcept
    : QWidget(parent),
  ...
  connect(&this->sourceField, &SourceFieldWidget::fileOpened, this,
          &ui::CentralWidget::fileOpened);

  connect(&this->sourceField, &SourceFieldWidget::textChanged, this,
          [this] { emit sourceDataChanged(*this->sourceField.document()); });

  connect(&this->targetField, &TargetFieldWidget::textChanged, this,
          [this] { emit targetDataChanged(*this->targetField.document()); });
}
